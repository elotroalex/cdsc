  ...
  var litmusApp = {
    ...
    litmus_menu: function () {
      ...
      function cloneMobileMenu($cloneItem, $mobileLoc) {
        ...
        var $submenu = $($mobileLoc)
          .find("li")
          .has(".sub-menu, .dropdown-menu");
        $submenu.prepend(
      ...
      cloneMobileMenu(
        ".header-middle .navigation .mainmenu",
        ".expand-block #mobile-main-menu"
      );
    ...
    hoverAnimation: function () {
      ...
      var ProjMli = $(
        ".portfolio-menu .dropdown-menu li a, .portfolio-menu.style-two li a"
      );
    ...
    scroll_top: function () {
      ...
      $(window).on("scroll", function () {
        if ($(this).scrollTop() >= $(this).height()) {
          $fixedHeader.addClass("sticky-show").removeClass("sticky-hide");
        } else if ($(this).scrollTop() >= 100) {
          $fixedHeader.addClass("sticky-hide").removeClass("sticky-show");
        } else {
          $fixedHeader.removeClass("sticky-hide");
        }
      });

      //Footer Scroll Top
      $("body").append(
        "<a href='#top' id='scroll-top' class='topbutton btn-hide'><span class='icon-arrows-up'></span></a>"
      );
