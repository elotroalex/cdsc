    ...
    var n =
      ...
      r =
              ...
              return (
                ...
                (e.prototype._removeElement = function (e) {
                  ...
                  t(e).removeClass(l.SHOW),
                    s.supportsTransitionEnd() && t(e).hasClass(l.FADE)
                      ? t(e)
        ...
        (function (t) {
              ...
              return (
                (e.prototype.toggle = function () {
                  ...
                  if (n) {
                    ...
                    if (o) {
                      if ("radio" === o.type)
                        if (o.checked && t(this._element).hasClass(s.ACTIVE))
                          e = !1;
                        else {
                      ...
                      if (e) {
                        if (
                          ...
                          return;
                        (o.checked = !t(this._element).hasClass(s.ACTIVE)),
                          t(o).trigger("change");
                      }
                      o.focus(), (i = !1);
                    }
                  ...
                  i &&
                    ...
                    e && t(this._element).toggleClass(s.ACTIVE);
                }),
                (e.prototype.dispose = function () {
          ...
          t(document)
            .on(a.CLICK_DATA_API, r.DATA_TOGGLE_CARROT, function (e) {
              e.preventDefault();
              var i = e.target;
              t(i).hasClass(s.BUTTON) || (i = t(i).closest(r.BUTTON)),
            ...
            m = (function () {
              ...
              return (
                ...
                (l.prototype._getConfig = function (i) {
                  return (
                    (i = t.extend({}, c, i)), s.typeCheckConfig(e, i, u), i
                  );
                }),
                ...
                (l.prototype._getItemByDirection = function (t, e) {
                  ...
                  if (((n && 0 === o) || (i && o === s)) && !this._config.wrap)
                    return e;
                  var r = (o + (t === d.PREV ? -1 : 1)) % this._items.length;
                  return -1 === r
                ...
                (l.prototype._slide = function (e, i) {
                  var n = this,
                    ...
                    a = i || (o && this._getItemByDirection(e, o)),
                  ...
                  if (
                    (e === d.NEXT
                      ? ((u = p.LEFT), (m = p.NEXT), (g = d.LEFT))
                      : ((u = p.RIGHT), (m = p.PREV), (g = d.RIGHT)),
                ...
                (l._jQueryInterface = function (e) {
                  return this.each(function () {
                    ...
                    if (
                      (i || ((i = new l(this, o)), t(this).data(r, i)),
                      "number" == typeof e)
                    )
                      i.to(e);
          ...
          var e = "collapse",
            ...
            f = (function () {
              function a(e, n) {
                ...
                for (var o = t(p.DATA_TOGGLE), r = 0; r < o.length; r++) {
                  var l = o[r],
                    c = s.getSelectorFromElement(l);
                  null !== c &&
                    t(c).filter(e).length > 0 &&
              ...
              return (
                ...
                (a.prototype.show = function () {
                  ...
                  if (
                    ...
                    !t(this._element).hasClass(d.SHOW)
                  ) {
                    var i = void 0,
                      n = void 0;
                    if (
        ...
        (function (t) {
            ...
            g = (function () {
              ...
              return (
                  ...
                  if (
                    ...
                    if ((l._clearMenus(), !i)) {
                      ...
                      if ((t(e).trigger(o), !o.isDefaultPrevented())) {
                        var s = this._element;
                        t(e).hasClass(d.DROPUP) &&
                          (t(this._menu).hasClass(d.MENULEFT) ||
                            t(this._menu).hasClass(d.MENURIGHT)) &&
                          (s = e),
                          ...
                          "ontouchstart" in document.documentElement &&
                            !t(e).closest(h.NAVBAR_NAV).length &&
                            t("body").children().on("mouseover", null, t.noop),
                          this._element.focus(),
                          this._element.setAttribute("aria-expanded", !0),
                          t(this._menu).toggleClass(d.SHOW),
                          t(e).toggleClass(d.SHOW).trigger(t.Event(u.SHOWN, n));
                      }
                    }
                  }
                }),
                ...
                (l.prototype._getPlacement = function () {
                  ...
                  return (
                    e.hasClass(d.DROPUP) || this._config.placement === p.TOP
                      ? ((i = p.TOP),
                        t(this._menu).hasClass(d.MENURIGHT) && (i = p.TOPEND))
                      : t(this._menu).hasClass(d.MENURIGHT) &&
                        (i = p.BOTTOMEND),
                    i
                  );
                ...
                (l._clearMenus = function (e) {
                  if (
                    ...
                    for (
                      var i = t.makeArray(t(h.DATA_TOGGLE)), n = 0;
                      n < i.length;
                      n++
                    ) {
                      var o = l._getParentFromElement(i[n]),
                        s = t(i[n]).data(r),
                        a = { relatedTarget: i[n] };
                      if (s) {
                        var c = s._menu;
                ...
                (l._dataApiKeydownHandler = function (e) {
                  if (
                    ...
                    if (
                      ...
                      var o = t(i).find(h.VISIBLE_ITEMS).get();
                      if (o.length) {
                      ...
                      if (27 === e.which) {
                        var r = t(i).find(h.DATA_TOGGLE)[0];
                        t(r).trigger("focus");
                      }
          ...
          t(document)
            .on(u.KEYDOWN_DATA_API, h.DATA_TOGGLE, g._dataApiKeydownHandler)
            .on(u.KEYDOWN_DATA_API, h.MENU, g._dataApiKeydownHandler)
            .on(u.CLICK_DATA_API + " " + u.KEYUP_DATA_API, g._clearMenus)
            .on(u.CLICK_DATA_API, h.DATA_TOGGLE, function (e) {
              e.preventDefault(),
                e.stopPropagation(),
          ...
          var e = "modal",
            ...
            p = (function () {
              ...
              return (
                ...
                (a.prototype._getConfig = function (i) {
                  return (
                    (i = t.extend({}, l, i)), s.typeCheckConfig(e, i, c), i
                  );
                }),
                ...
                (a.prototype._resetScrollbar = function () {
                  t(h.FIXED_CONTENT).each(function (e, i) {
                    ...
                    t(h.NAVBAR_TOGGLER).each(function (e, i) {
                ...
                (a._jQueryInterface = function (e, i) {
                  return this.each(function () {
                    ...
                    if (
                      (o || ((o = new a(this, s)), t(this).data("bs.modal", o)),
                      "string" == typeof e)
                    ) {
                      if (void 0 === o[e])
                        throw new Error('No method named "' + e + '"');
              ...
              return (
                ...
                (r._jQueryInterface = function (e) {
                  return this.each(function () {
                    ...
                    if (
                      (i ||
                        ((i = new r(this, o)), t(this).data("bs.scrollspy", i)),
                      "string" == typeof e)
                    ) {
                      if (void 0 === i[e])
                        throw new Error('No method named "' + e + '"');
            ...
            l = (function () {
              ...
              return (
                    ...
                    if (
                      ...
                      var h = function () {
                        var i = t.Event(n.HIDDEN, {
                          ...
                          s = t.Event(n.SHOWN, { relatedTarget: o });
                ...
                (e.prototype._activate = function (e, i, n) {
                  ...
                  l && c
                    ? t(l).one(s.TRANSITION_END, u).emulateTransitionEnd(150)
                    : u(),
                  ...
                  if (this.isWithContent() && this._isEnabled) {
                    ...
                    var d = function () {
                      ...
                      (e._hoverState = null),
                        ...
                        i === h.OUT && e._leave(null, e);
                    };
                    s.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE)
                      ? t(this.tip)
        ...
        g = (function (r) {
          ...
          return (
            ...
            (c.prototype.addAttachmentClass = function (t) {
              s(this.getTipElement()).addClass("bs-popover-" + t);
            }),
            ...
            (c._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e || ((e = new c(this, i)), s(this).data("bs.popover", e)),
                  "string" == typeof t)
                ) {
                  if (void 0 === e[t])
...
!(function (t) {
  ...
  t.extend(t.easing, {
    ...
    easeInOutElastic: function (t) {
      return 0 === t
        ...
        ? 1
        : t < 0.5
        ? (-i(2, 20 * t - 10) * o((20 * t - 11.125) * u)) / 2
        : (i(2, -20 * t + 10) * o((20 * t - 11.125) * u)) / 2 + 1;
    },
  ...
  jQuery.Velocity
    ? console.log(
        "Velocity is already loaded. You may be needlessly importing Velocity again; note that Bsmkit includes Velocity."
      )
    : ((function (t) {
        function e(t) {
          var e = t.length,
                    ...
                    (t = a[o]),
                      a !== (n = s[o]) &&
                        (u && n && (i.isPlainObject(n) || (e = i.isArray(n)))
                          ? (e
                              ? ((e = !1), (r = t && i.isArray(t) ? t : []))
                              : (r = t && i.isPlainObject(t) ? t : {}),
                            (a[o] = i.extend(u, r, n)))
                          : void 0 !== n && (a[o] = n));
              return a;
            }),
      ...
      (function (t) {
        ...
        return (function (t, e, i, n) {
          ...
          function l(t, i, n, o) {
            ...
            function p(e) {
              for (var i = 0, o = 1, s = _ - 1; o != s && T[o] <= e; ++o)
                i += b;
              var r = i + ((e - T[--o]) / (T[o + 1] - T[o])) * b,
                a = c(r, t, n);
              return a >= g ? u(e, r) : 0 == a ? r : h(e, i, i + b);
            }
            function f() {
              (E = !0), (t != i || n != o) && d();
            }
          ...
          function c(t, e) {
            ...
            return (
              m.isString(t)
                ? _.Easings[t] || (i = !1)
                : (i =
                    m.isArray(t) && 1 === t.length
                      ? a.apply(null, t)
                      : m.isArray(t) && 2 === t.length
                      ? b.apply(null, t.concat([e]))
                      : !(!m.isArray(t) || 4 !== t.length) && l.apply(null, t)),
              !1 === i &&
                (i = _.Easings[_.defaults.easing] ? _.defaults.easing : y),
              i
            );
          }
          function u(t) {
            if (t) {
              ...
              i > 1e4 && (_.State.calls = o(_.State.calls));
              for (var s = 0; i > s; s++)
                if (_.State.calls[s]) {
                  var a = _.State.calls[s],
                    ...
                    f = !!p,
                    g = null;
                  p || (p = _.State.calls[s][3] = e - 16);
                  for (
                    var v = Math.min((e - p) / c.duration, 1),
                      y = 0,
                      b = l.length;
                    b > y;
                    y++
                    ...
                    if (r(E)) {
                      ...
                      if (
                        ...
                        w.setPropertyValue(E, "display", c.display);
                      }
                      c.visibility !== n &&
                        "hidden" !== c.visibility &&
                      ...
                      for (var S in C)
                        if ("element" !== S) {
                          ...
                          if (1 === v) A = I.endValue;
                            ...
                            if (
                              ((A = I.startValue + P * O(v, c, P)),
                              !f && A === I.currentValue)
                            )
                              continue;
                          }
                          if (((I.currentValue = A), "tween" === S)) g = A;
                          else {
                            if (w.Hooks.registered[S]) {
                              var D = w.Hooks.getRoot(S),
                                N = r(E).rootPropertyValueCache[D];
                            ...
                            var L = w.setPropertyValue(
                              ...
                              S,
                              I.currentValue +
                                (0 === parseFloat(A) ? "" : I.unitType),
                              I.rootPropertyValue,
                              I.scrollData
                            );
                            w.Hooks.registered[S] &&
                              (r(E).rootPropertyValueCache[D] = w.Normalizations
                                .registered[D]
                      ...
                      c.mobileHA &&
                        r(E).transformCache.translate3d === n &&
                        ((r(E).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (x = !0)),
                        x && w.flushTransformCache(E);
                    }
                  }
                  c.display !== n &&
                    "none" !== c.display &&
                    (_.State.calls[s][2].display = !1),
                    c.visibility !== n &&
                      "hidden" !== c.visibility &&
                      (_.State.calls[s][2].visibility = !1),
                    c.progress &&
                      c.progress.call(
                        a[1],
                        a[1],
                        v,
                        Math.max(0, p + c.duration - e),
                        p,
                        g
                      ),
                    1 === v && d(s);
            ...
            for (
              ...
              if (
                (e ||
                  ...
                  "hidden" === s.visibility &&
                    w.setPropertyValue(d, "visibility", s.visibility)),
                !0 !== s.loop &&
                  (h.queue(d)[1] === n ||
                ...
                h.each(w.Lists.transforms3D, function (t, e) {
                  ...
                  r(d).transformCache[e] !== n &&
                    new RegExp("^\\(" + i + "[^.]").test(o) &&
                    ((p = !0), delete r(d).transformCache[e]);
                }),
                  s.mobileHA &&
                    ((p = !0), delete r(d).transformCache.translate3d),
              ...
              a && !0 !== s.loop && a(o),
                r(d) &&
                  !0 === s.loop &&
                  !e &&
                  (h.each(r(d).tweensContainer, function (t, e) {
                    /^rotate/.test(t) &&
                  ...
                  _(d, "reverse", { loop: !0, delay: s.delay })),
            ...
            if (!(7 >= p)) {
              ...
              var w = (_.CSS = {
                ...
                Hooks: {
                  ...
                  registered: {},
                  register: function () {
                    for (s = 0; s < w.Lists.colors.length; s++) {
                      var t =
                        "color" === w.Lists.colors[s]
                          ? "0 0 0 1"
                          : "255 255 255 1";
                      w.Hooks.templates[w.Lists.colors[s]] = [
                    ...
                    if (p)
                      for (e in w.Hooks.templates) {
                        n = (i = w.Hooks.templates[e])[0].split(" ");
                        var o = i[1].match(w.RegEx.valueSplit);
                        "Color" === n[0] &&
                          (n.push(n.shift()),
                          o.push(o.shift()),
                          (w.Hooks.templates[e] = [n.join(" "), o.join(" ")]));
                      }
                    for (e in w.Hooks.templates) {
                      n = (i = w.Hooks.templates[e])[0].split(" ");
                      for (var s in n) {
                  ...
                  cleanRootPropertyValue: function (t, e) {
                    return (
                      ...
                      w.Values.isCSSNullValue(e) &&
                        (e = w.Hooks.templates[t][1]),
                      e
                    );
                  },
                  ...
                  injectValue: function (t, e, i) {
                    ...
                    if (n) {
                      var o,
                        ...
                        r = n[1];
                      return (
                        (i = w.Hooks.cleanRootPropertyValue(s, i)),
                        (o = i.toString().match(w.RegEx.valueSplit)),
                        (o[r] = e),
                        o.join(" ")
                      );
                    }
                ...
                Names: {
                  ...
                  SVGAttribute: function (t) {
                    ...
                    return (
                      (p || (_.State.isAndroid && !_.State.isChrome)) &&
                        (e += "|transform"),
                  ...
                  prefixCheck: function (t) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        m.isString(_.State.prefixElement.style[o]))
                      )
                        return (_.State.prefixMatches[t] = o), [o, !0];
                    }
                    return [t, !1];
                  },
                },
                ...
                getPropertyValue: function (t, i, o, s) {
                      ...
                      if (
                        ...
                        if (
                          ...
                          var u =
                            t.offsetHeight -
                            (parseFloat(
                              w.getPropertyValue(t, "borderTopWidth")
                            ) || 0) -
                            (parseFloat(
                              w.getPropertyValue(t, "borderBottomWidth")
                            ) || 0) -
                            (parseFloat(w.getPropertyValue(t, "paddingTop")) ||
                              0) -
                            (parseFloat(
                              w.getPropertyValue(t, "paddingBottom")
                            ) || 0);
                          return o(), u;
                        }
                        if (
                          ...
                          var d =
                            t.offsetWidth -
                            (parseFloat(
                              w.getPropertyValue(t, "borderLeftWidth")
                            ) || 0) -
                            (parseFloat(
                            ...
                            (parseFloat(w.getPropertyValue(t, "paddingLeft")) ||
                              0) -
                            (parseFloat(
                              w.getPropertyValue(t, "paddingRight")
                            ) || 0);
                          return o(), d;
                        }
                      }
                  ...
                  if (w.Hooks.registered[i]) {
                    var c = i,
                      u = w.Hooks.getRoot(c);
                    o === n &&
                      (o = w.getPropertyValue(t, w.Names.prefixCheck(u)[0])),
                      w.Normalizations.registered[u] &&
                        (o = w.Normalizations.registered[u]("extract", t, o)),
                      (l = w.Hooks.extractValue(c, o));
                  } else if (w.Normalizations.registered[i]) {
                    var d, f;
                    "transform" !==
                      (d = w.Normalizations.registered[i]("name", t)) &&
                      ((f = a(t, w.Names.prefixCheck(d)[0])),
                      w.Values.isCSSNullValue(f) &&
                        w.Hooks.templates[i] &&
                        (f = w.Hooks.templates[i][1])),
                ...
                setPropertyValue: function (t, i, n, o, s) {
                  ...
                  if ("scroll" === i)
                    s.container
                      ...
                      : "Left" === s.direction
                      ? e.scrollTo(n, s.alternateValue)
                      : e.scrollTo(s.alternateValue, n);
                  else if (
                    ...
                    if (w.Hooks.registered[i]) {
                      var l = i,
                        c = w.Hooks.getRoot(i);
                      (o = o || w.getPropertyValue(t, c)),
                        (n = w.Hooks.injectValue(l, n, o)),
                        (i = c);
                    }
                    if (
                      (w.Normalizations.registered[i] &&
                      ...
                      r(t) && r(t).isSVG && w.Names.SVGAttribute(i)
                        ? t.setAttribute(i, n)
                        : (t.style[a] = n);
                    _.debug >= 2 &&
                ...
                flushTransformCache: function (t) {
                  ...
                  if (
                    ...
                    h.each(r(t).transformCache, function (e) {
                      return (
                        (o = r(t).transformCache[e]),
                        "transformPerspective" === e
                          ? ((s = o), !0)
                          : (9 === p && "rotateZ" === e && (e = "rotate"),
                            void (i += e + o + " "))
                      );
                    }),
                      s && (i = "perspective" + s + " " + i);
                ...
                (_.hook = function (t, e, i) {
                  ...
                  return (
                    ...
                    h.each(t, function (t, s) {
                      if ((r(s) === n && _.init(s), i === n))
                        o === n && (o = _.CSS.getPropertyValue(s, e));
                      else {
                        var a = _.CSS.setPropertyValue(s, e, i);
                        "transform" === a[0] && _.CSS.flushTransformCache(s),
                          (o = a);
                      }
                    }),
                    o
              ...
              var C = function () {
                ...
                function o() {
                  function t(t) {
                          ...
                          ? ((i = t[0]),
                            ...
                            w.RegEx.isHex.test(t[1])
                              ...
                              : ((m.isString(t[1]) &&
                                  !w.RegEx.isHex.test(t[1])) ||
                                  m.isArray(t[1])) &&
                                ((o = e ? t[1] : c(t[1], a.duration)),
                                t[2] !== n && (r = t[2])))
                          : (i = t),
                        e || (o = o || a.easing),
                        m.isFunction(i) && (i = i.call(s, E, T)),
                        m.isFunction(r) && (r = r.call(s, E, T)),
                        [i || 0, o, r]
                      );
                    }
                    function p(t, e) {
                    ...
                    if ("scroll" === S) {
                      var v,
                        b,
                        C,
                        x = /^x$/i.test(a.axis) ? "Left" : "Top",
                        A = parseFloat(a.offset) || 0;
                      a.container
                        ? m.isWrapped(a.container) || m.isNode(a.container)
                          ? ((a.container = a.container[0] || a.container),
                            (v = a.container["scroll" + x]),
                            (C = v + h(s).position()[x.toLowerCase()] + A))
                          : (a.container = null)
                        : ((v =
                            _.State.scrollAnchor[
                              _.State["scrollProperty" + x]
                            ]),
                          (b =
                            _.State.scrollAnchor[
                              _.State[
                      ...
                      if (!r(s).tweensContainer)
                        return void h.dequeue(s, a.queue);
                      "none" === r(s).opts.display &&
                        (r(s).opts.display = "auto"),
                        "hidden" === r(s).opts.visibility &&
                          (r(s).opts.visibility = "visible"),
                        (r(s).opts.loop = !1),
                        (r(s).opts.begin = null),
                        (r(s).opts.complete = null),
                        y.easing || delete a.easing,
                        y.duration || delete a.duration,
                        (a = h.extend({}, r(s).opts, a));
                      P = h.extend(!0, {}, r(s).tweensContainer);
                      for (var I in P)
                        if ("element" !== I) {
                          var O = P[I].startValue;
                          (P[I].startValue = P[I].currentValue = P[I].endValue),
                            (P[I].endValue = O),
                            m.isEmptyObject(y) || (P[I].easing = a.easing),
                            _.debug &&
                              console.log(
                      ...
                      r(s).tweensContainer &&
                        !0 === r(s).isAnimating &&
                        (P = r(s).tweensContainer),
                        h.each(g, function (t, e) {
                          if (
                            RegExp("^" + w.Lists.colors.join("$|^") + "$").test(
                              t
                            )
                          ) {
                            var i = d(e, !0),
                      ...
                      for (var L in g) {
                        ...
                        var R = w.Hooks.getRoot(L),
                          V = !1;
                        if (
                          r(s).isSVG ||
                          "tween" === R ||
                          !1 !== w.Names.prefixCheck(R)[1] ||
                          w.Normalizations.registered[R] !== n
                        ) {
                          ((a.display !== n &&
                            null !== a.display &&
                            "none" !== a.display) ||
                            ...
                            0 !== H &&
                            (W = 0),
                            a._cacheValues && P && P[L]
                              ? (W === n && (W = P[L].endValue + P[L].unitType),
                                (V = r(s).rootPropertyValueCache[R]))
                              : w.Hooks.registered[L]
                              ? W === n
                                ? ((V = w.getPropertyValue(s, R)),
                                  (W = w.getPropertyValue(s, L, V)))
                                : (V = w.Hooks.templates[R][1])
                              : W === n && (W = w.getPropertyValue(s, L));
                          var z,
                            $,
                            F,
                            B = !1;
                              ...
                              o =
                                ...
                                (function () {
                                  var t = {
                                    ...
                                    n =
                                      t.position === D.lastPosition &&
                                      t.myParent === D.lastParent,
                                  ...
                                  return (
                                    null === D.remToPx &&
                                      (D.remToPx =
                                        parseFloat(
                                          w.getPropertyValue(i.body, "fontSize")
                                        ) || 16),
                                    null === D.vwToPx &&
                                      ((D.vwToPx =
                    ...
                    l.element &&
                      ...
                      N.push(l),
                      "" === a.queue &&
                        ((r(s).tweensContainer = l), (r(s).opts = a)),
                      (r(s).isAnimating = !0),
                      E === T - 1
                        ? (_.State.calls.push([N, f, a, null, k.resolver]),
                          !1 === _.State.isTicking &&
                            ((_.State.isTicking = !0), u()))
                        : E++);
                  }
                  var o,
                    s = this,
                    a = h.extend({}, _.defaults, y),
                    l = {};
                  switch (
                    (r(s) === n && _.init(s),
                    parseFloat(a.delay) &&
                      !1 !== a.queue &&
                      h.queue(s, a.queue, function (t) {
                  ...
                  !1 !== _.mock &&
                    (!0 === _.mock
                      ...
                      : ((a.duration *= parseFloat(_.mock) || 1),
                        (a.delay *= parseFloat(_.mock) || 1))),
                    (a.easing = c(a.easing, a.duration)),
                    a.begin && !m.isFunction(a.begin) && (a.begin = null),
                    a.progress &&
                      !m.isFunction(a.progress) &&
                      (a.progress = null),
                    a.complete &&
                      !m.isFunction(a.complete) &&
                      (a.complete = null),
                    a.display !== n &&
                      null !== a.display &&
                      ((a.display = a.display.toString().toLowerCase()),
                      "auto" === a.display &&
                        (a.display = _.CSS.Values.getDisplayType(s))),
                    a.visibility !== n &&
                      null !== a.visibility &&
                      (a.visibility = a.visibility.toString().toLowerCase()),
                    (a.mobileHA =
                      a.mobileHA && _.State.isMobile && !_.State.isGingerbread),
                    !1 === a.queue
                      ? a.delay
                        ? setTimeout(t, a.delay)
                        : t()
                      : h.queue(s, a.queue, function (e, i) {
                          return !0 === i
                            ? (k.promise && k.resolver(f), !0)
                            : ((_.velocityQueueEntryFlag = !0), void t());
                        }),
                    ("" !== a.queue && "fx" !== a.queue) ||
                      "inprogress" === h.queue(s)[0] ||
                      h.dequeue(s);
                }
                var a,
                  l,
                ...
                if (
                  ...
                  b
                    ...
                    : ((g = arguments[p]), (y = arguments[p + 1]));
                  var T = f.length,
                    E = 0;
                  if (!/^(stop|finish)$/i.test(g) && !h.isPlainObject(y)) {
                    y = {};
                    for (var x = p + 1; x < arguments.length; x++)
                      m.isArray(arguments[x]) ||
                      (!/^(fast|normal|slow)$/i.test(arguments[x]) &&
                        !/^\d/.test(arguments[x]))
                        ? m.isString(arguments[x]) || m.isArray(arguments[x])
                          ? (y.easing = arguments[x])
                          : m.isFunction(arguments[x]) &&
                            (y.complete = arguments[x])
                        : (y.duration = arguments[x]);
                  }
                  var k = { promise: null, resolver: null, rejecter: null };
                  a &&
                    _.Promise &&
                    (k.promise = new _.Promise(function (t, e) {
                  ...
                  switch (g) {
                    ...
                    case "stop":
                      ...
                      var A = [];
                      return (
                        h.each(_.State.calls, function (t, e) {
                          e &&
                            h.each(e[1], function (i, o) {
                              var s = y === n ? "" : y;
                              return (
                                (!0 !== s &&
                                  e[2].queue !== s &&
                                  (y !== n || !1 !== e[2].queue)) ||
                                void h.each(f, function (i, n) {
                                  n === o &&
                                    ((!0 === y || m.isString(y)) &&
                                      (h.each(
                                        h.queue(n, m.isString(y) ? y : ""),
                                        function (t, e) {
                        ...
                        "stop" === g &&
                          ...
                          k.promise && k.resolver(f)),
                        t()
                      );
                    default:
                      if (!h.isPlainObject(g) || m.isEmptyObject(g)) {
                        if (m.isString(g) && _.Redirects[g]) {
                          var I = (M = h.extend({}, y)).duration,
                            O = M.delay || 0;
                          return (
                            !0 === M.backwards &&
                              (f = h.extend(!0, [], f).reverse()),
                            h.each(f, function (t, e) {
                              parseFloat(M.stagger)
                                ? (M.delay = O + parseFloat(M.stagger) * t)
                                : m.isFunction(M.stagger) &&
                                  (M.delay = O + M.stagger.call(e, t, T)),
                                M.drag &&
                                  ((M.duration =
                                    parseFloat(I) ||
                                    (/^(callout|transition)/.test(g)
                                      ? 1e3
                                      : v)),
                                  (M.duration = Math.max(
                                    M.duration *
                                      (M.backwards ? 1 - t / T : (t + 1) / T),
                                    0.75 * M.duration,
                                    200
                                  ))),
                                _.Redirects[g].call(
                        ...
                        return (
                          k.promise ? k.rejecter(new Error(P)) : console.log(P),
                          t()
                        );
                      }
                      S = "start";
                  ...
                  var L,
                    M = h.extend({}, _.defaults, y);
                  if (
                    ((M.loop = parseInt(M.loop)), (L = 2 * M.loop - 1), M.loop)
                  )
                    for (var H = 0; L > H; H++) {
                      var j = { delay: M.delay, progress: M.progress };
                      H === L - 1 &&
                        ((j.display = M.display),
                        (j.visibility = M.visibility),
                        (j.complete = M.complete)),
                        C(f, "reverse", j);
                    }
                  return t();
                }
              };
              (_ = h.extend(C, _)).animate = C;
              ...
              return (
                ...
                h.each(["Down", "Up"], function (t, e) {
                  _.Redirects["slide" + e] = function (t, i, o, s, r, a) {
                    var l = h.extend({}, i),
                      c = l.begin,
                      u = l.complete,
                      d = {
                ...
                h.each(["In", "Out"], function (t, e) {
                  _.Redirects["fade" + e] = function (t, i, o, s, r, a) {
                    var l = h.extend({}, i),
                      c = { opacity: "In" === e ? 1 : 0 },
                      u = l.complete;
                    (l.complete =
  ...
  (function (t, e, i, n) {
    ...
    function w(t, e) {
      for (
        var i, o, s = e[0].toUpperCase() + e.slice(1), r = 0;
        r < lt.length;

      ) {
        if (((i = lt[r]), (o = i ? i + s : e) in t)) return o;
        r++;
      }
      return n;
    }
    ...
    function x(t) {
      ...
      return new (e || (vt ? R : yt ? $ : gt ? B : W))(t, k);
    }
    function k(t, e, i) {
    ...
    function S(t, e) {
      ...
      (e.timeStamp = pt()),
        ...
        (e.scale = r ? j(r.pointers, n) : 1),
        (e.rotation = r ? H(r.pointers, n) : 0),
        I(i, e);
      var c = t.element;
    ...
    function I(t, e) {
      ...
      if (e.eventType != xt && (l > wt || a.velocity === n)) {
        var c = a.deltaX - e.deltaX,
          u = a.deltaY - e.deltaY,
          d = D(l, c, u);
        (o = d.x),
          (s = d.y),
          (i = ht(d.x) > ht(d.y) ? d.x : d.y),
          (r = N(c, u)),
          (t.lastInterval = e);
      } else
        (i = a.velocity),
    ...
    function H(t, e) {
      return M(e[1], e[0], Mt) - M(t[1], t[0], Mt);
    }
    function j(t, e) {
    ...
    function z(t, e) {
      ...
      return e & (Et | xt) && (i = b(i.concat(n), "identifier", !0)), [i, n];
    }
    function $() {
    ...
    function F(t, e) {
      ...
      for (o = 0; o < r.length; )
        n[r[o].identifier] && a.push(r[o]),
          e & (Et | xt) && delete n[r[o].identifier],
          o++;
    ...
    function ot(t, e) {
      return (
        (e = e || {}),
        (e.recognizers = h(e.recognizers, ot.defaults.preset)),
        new st(t, e)
      );
    }
    function st(t, e) {
      (e = e || {}),
        (this.options = l(e, ot.defaults)),
    ...
    var Ht = { mousedown: Ct, mousemove: Tt, mouseup: Et },
      jt = "mousedown",
    ...
    var Rt = {
      ...
      Vt = { 2: _t, 3: "pen", 4: bt, 5: "kinect" },
      zt = "pointerdown",
      $t = "pointermove pointerup pointercancel";
    t.MSPointerEvent &&
      ((zt = "MSPointerDown"),
      ($t = "MSPointerMove MSPointerUp MSPointerCancel")),
      c(R, E, {
        handler: function (t) {
          var e = this.store,
            i = !1,
    ...
    var Ft = { touchstart: Ct, touchmove: Tt, touchend: Et, touchcancel: xt },
      Bt = "touchstart",
    ...
    var Qt = { touchstart: Ct, touchmove: Tt, touchend: Et, touchcancel: xt },
    ...
    c($, E, {
      ...
      c(B, E, {
        handler: function (t, e, i) {
          ...
          e & (Et | xt) && (this.mouse.allow = !0), this.callback(t, e, i);
        },
        destroy: function () {
          this.touch.destroy(), this.mouse.destroy();
        },
      });
    var Xt = w(ct.style, "touchAction"),
      Yt = Xt !== n,
      Gt = "compute",
      Kt = "auto",
      Zt = "manipulation",
    ...
    q.prototype = {
      set: function (t) {
        t == Gt && (t = this.compute()),
          Yt && (this.manager.element.style[Xt] = t),
    ...
    (U.prototype = {
      ...
      dropRecognizeWith: function (t) {
        return s(t, "dropRecognizeWith", this)
          ? this
          : ((t = G(t, this)), delete this.simultaneous[t.id], this);
      },
      ...
      recognize: function (t) {
        ...
        return d(this.options.enable, [this, e])
          ? (this.state & (re | ae | 32) && (this.state = ie),
            (this.state = this.process(e)),
            void (this.state & (ne | oe | se | ae) && this.tryEmit(e)))
      ...
      c(Z, K, {
        ...
        getTouchAction: function () {
          var t = this.options.direction,
            e = [];
          return t & Pt && e.push(ee), t & Dt && e.push(te), e;
        },
        ...
        attrTest: function (t) {
          return (
            K.prototype.attrTest.call(this, t) &&
            (this.state & ne || (!(this.state & ne) && this.directionTest(t)))
          );
        },
        emit: function (t) {
      ...
      c(J, K, {
        ...
        attrTest: function (t) {
          return (
            ...
            (Math.abs(t.scale - 1) > this.options.threshold || this.state & ne)
          );
        },
        emit: function (t) {
      ...
      c(tt, U, {
        ...
        process: function (t) {
          ...
          if (((this._input = t), !n || !i || (t.eventType & (Et | xt) && !s)))
            this.reset();
          ...
          else if (t.eventType & Et) return re;
          return 32;
        },
        reset: function () {
      ...
      c(et, K, {
        ...
        attrTest: function (t) {
          return (
            this._super.attrTest.call(this, t) &&
            (Math.abs(t.rotation) > this.options.threshold || this.state & ne)
          );
        },
      }),
      c(it, K, {
          ...
          for (var s = 0; s < n.length; )
            (i = n[s]),
              2 === e.stopped || (o && i != o && !i.canRecognizeWith(o))
                ? i.reset()
                : i.recognize(t),
              !o && i.state & (ne | oe | se) && (o = e.curRecognizer = i),
              s++;
        }
      },
      get: function (t) {
  ...
  (Bsmkit.objectSelectorString = function (t) {
    return (
      (t.prop("tagName") || "") +
      (t.attr("id") || "") +
      (t.attr("class") || "")
  ...
  (Bsmkit.escapeHash = function (t) {
    return t.replace(/(:|\.|\[|\]|,|=)/g, "\\$1");
  }),
  (Bsmkit.elementOrParentIsFixed = function (t) {
    var e = $(t),
      i = !1;
    return (
...
Bsmkit.throttle = function (t, e, i) {
  var n,
    o,
    s,
    r = null,
    ...
    return (
      ...
      u <= 0
        ? (clearTimeout(r),
          ...
          (s = t.apply(n, o)),
          (n = o = null))
        : r || !1 === i.trailing || (r = setTimeout(l, u)),
      s
    );
  };
};
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
  (function (t) {
    (t.fn.collapsible = function (e, i) {
      ...
      return (
        ...
        this.each(function () {
          function n(e) {
            (h = d.find("> li > .bsm-collapsible-header")),
              e.hasClass("active")
                ? e.parent().addClass("active")
                : e.parent().removeClass("active"),
              e.parent().hasClass("active")
                ? e
                    .siblings(".bsm-collapsible-body")
                    .stop(!0, !1)
                    .slideDown({
                      duration: 350,
                      easing: "easeOutQuart",
              ...
              h.not(e).removeClass("active").parent().removeClass("active"),
              h
                .not(e)
                .parent()
                .children(".bsm-collapsible-body")
                .stop(!0, !1)
                .each(function () {
                  t(this).is(":visible") &&
                    t(this).slideUp({
                      ...
                      complete: function () {
                        t(this).css("height", ""),
                          a(t(this).siblings(".bsm-collapsible-header"));
                      },
                    });
                });
          }
          ...
          function r(t, i) {
            i || t.toggleClass("active"),
              e.accordion || "accordion" === p || void 0 === p ? n(t) : s(t),
              a(t);
          }
          function a(t) {
            t.hasClass("active")
          ...
          function c(t) {
            return t.closest("li > .bsm-collapsible-header");
          }
          function u() {
            d.off("click.collapse", "> li > .bsm-collapsible-header");
          }
          var d = t(this),
            h = t(this).find("> li > .bsm-collapsible-header"),
            p = d.data("collapsible");
          if ("destroy" !== o)
            if (i >= 0 && i < h.length) {
              var f = h.eq(i);
              f.length &&
                ("open" === o || ("close" === o && f.hasClass("active"))) &&
                r(f);
            } else
              u(),
                d.on(
                  "click.collapse",
                  "> li > .bsm-collapsible-header",
                  function (e) {
                    var i = t(e.target);
                    l(i) && (i = c(i)), r(i);
                  }
                ),
                e.accordion || "accordion" === p || void 0 === p
                  ? r(h.filter(".active").first(), !0)
          ...
          : void this.each(function () {
              function n() {
                void 0 !== r.data("induration") &&
                  (a.inDuration = r.data("induration")),
                  void 0 !== r.data("outduration") &&
                    (a.outDuration = r.data("outduration")),
                  void 0 !== r.data("constrainwidth") &&
                    (a.constrainWidth = r.data("constrainwidth")),
                  void 0 !== r.data("hover") && (a.hover = r.data("hover")),
                  void 0 !== r.data("gutter") && (a.gutter = r.data("gutter")),
                  void 0 !== r.data("beloworigin") &&
                    (a.belowOrigin = r.data("beloworigin")),
                  void 0 !== r.data("alignment") &&
                    (a.alignment = r.data("alignment")),
                  void 0 !== r.data("stoppropagation") &&
                    (a.stopPropagation = r.data("stoppropagation"));
              }
              function o(e) {
                "focus" === e && (l = !0),
                  n(),
                ...
                var o = window.innerHeight,
                  u = r.innerHeight(),
                  d = r.offset().left,
                  h = r.offset().top - t(window).scrollTop(),
                  p = a.alignment,
                  f = 0,
                  m = 0,
                  g = 0;
                ...
                if (
                  (_.is("body") ||
                    (_[0].scrollHeight > _[0].clientHeight &&
                      (v = _[0].scrollTop),
                    _[0].scrollWidth > _[0].clientWidth &&
                      (y = _[0].scrollLeft)),
                  d + c.innerWidth() > t(window).width()
                    ? (p = "right")
                    : d - c.innerWidth() + r.innerWidth() < 0 && (p = "left"),
                  h + c.innerHeight() > o)
                )
                  if (h + u - c.innerHeight() < 0) {
                    var b = o - h - g;
                    c.css("max-height", b);
                  } else g || (g += u), (g -= c.innerHeight());
                "left" === p
                  ? ((f = a.gutter), (m = r.position().left + f))
                  : "right" === p &&
                    (c.stop(!0, !0).css({ opacity: 0, left: 0 }),
                    (m = r.position().left + i - c.width() + (f = -a.gutter))),
                  c.css({
                    position: "absolute",
                    top: r.position().top + g + v,
                    left: m + y,
                  }),
                  c
                    .slideDown({
                  ...
                  setTimeout(function () {
                    t(document).on("click." + c.attr("id"), function (e) {
                      s(), t(document).off("click." + c.attr("id"));
                    });
                  }, 0);
              }
              function s() {
                (l = !1),
                  c.fadeOut(a.outDuration),
                  c.removeClass("active"),
                  r.removeClass("active"),
                  t(document).off("click." + c.attr("id")),
                  setTimeout(function () {
                    c.css("max-height", "");
                  }, a.outDuration);
              }
              ...
              if ((n(), r.after(c), a.hover)) {
                var u = !1;
                r.off("click." + r.attr("id")),
                  r.on("mouseenter", function (t) {
                    !1 === u && (o(), (u = !0));
                  }),
                  r.on("mouseleave", function (e) {
                    var i = e.toElement || e.relatedTarget;
                    t(i).closest(".bsm-dropdown-content").is(c) ||
                      (c.stop(!0, !0), s(), (u = !1));
                  }),
                  c.on("mouseleave", function (e) {
                    var i = e.toElement || e.relatedTarget;
                    t(i).closest(".dropdown-button").is(r) ||
                      (c.stop(!0, !0), s(), (u = !1));
                  });
              } else
                r.off("click." + r.attr("id")),
                  r.on("click." + r.attr("id"), function (e) {
                    l ||
                      (r[0] != e.currentTarget ||
                      r.hasClass("active") ||
                      0 !== t(e.target).closest(".bsm-dropdown-content").length
                        ? r.hasClass("active") &&
                          (s(), t(document).off("click." + c.attr("id")))
                        : (e.preventDefault(),
                          a.stopPropagation && e.stopPropagation(),
                          o("click")));
                  });
  ...
  (function (t) {
      ...
      i = (function () {
        function i(e, n) {
          _classCallCheck(this, i),
            ...
            (this.$overlay = t('<div class="bsm-modal-overlay"></div>')),
            i._increment++,
            i._count++,
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  t.extend(this.$el[0].style, { display: "block", opacity: 0 }),
                  ...
                  var i = {
                    ...
                    ease: "easeOutCubic",
                    complete: function () {
                      "function" == typeof e.options.ready &&
                        e.options.ready.call(e, e.$el, e.openingTrigger);
                    },
                  };
                  this.$el[0].classList.contains("bottom-sheet")
                    ? Vel(this.$el[0], { bottom: 0, opacity: 1 }, i)
                  ...
                  var e = {
                    ...
                    complete: function () {
                      (t.$el[0].style.display = "none"),
                        "function" == typeof t.options.complete &&
                          t.options.complete.call(t, t.$el),
                        t.$overlay[0].remove();
                    },
                  };
                  this.$el[0].classList.contains("bottom-sheet")
                    ? Vel(this.$el[0], { bottom: "-100%", opacity: 0 }, e)
                    : Vel(
                        this.$el[0],
                        {
    ...
    (i._increment = 0),
      (i._count = 0),
      (window.Bsmkit.Modal = i),
      (t.fn.modal = function (e) {
        return i.prototype[e]
          ? "get" === e.slice(0, 3)
            ? this.first()[0].M_Modal[e]()
            : this.each(function () {
                this.M_Modal[e]();
              })
          : "object" != typeof e && e
  ...
  (function (t) {
    (t.fn.bsmbox = function () {
      return this.each(function () {
        function e() {
          s = !1;
          var e = a.parent(".bsm-placeholder"),
            n = (window.innerWidth, window.innerHeight, a.data("width")),
            l = a.data("height");
          a.velocity("stop", !0),
            t("#bsmbox-overlay").velocity("stop", !0),
            t(".bsmbox-caption").velocity("stop", !0),
            t(window).off("scroll.bsmbox"),
            t(document).off("keyup.bsmbox"),
            t(window).off("resize.bsmbox"),
            t("#bsmbox-overlay").velocity(
              { opacity: 0 },
              {
                duration: r,
                queue: !1,
        ...
        if (!t(this).hasClass("initialized")) {
          ...
          var i,
            ...
            r = 200,
            a = t(this),
            l = t("<div></div>").addClass("bsm-placeholder"),
            c = a.attr("style");
          a.wrap(l),
            a.on("click", function () {
              var r = a.parent(".bsm-placeholder"),
                l = window.innerWidth,
              ...
              for (; null !== n && !t(n).is(document); ) {
                var h = t(n);
                "visible" !== h.css("overflow") &&
                  (h.css("overflow", "visible"),
                  (i = void 0 === i ? h : i.add(h))),
                  (n = n.parentNode);
              }
              a.css({
                position: "absolute",
                ...
                .data("width", u)
                .data("height", d);
              var p = t('<div id="bsmbox-overlay"></div>')
                .css({ opacity: 0 })
                .click(function () {
                  !0 === s && e();
                });
              ...
              if (
                ...
                var m = t('<div class=bsmbox-caption"></div>');
              ...
              u / l > d / c
                          ...
                          a.css({ left: 0, top: 0 }).velocity(
                            {
                              ...
                              left:
                                ...
                                l / 2 -
                                a.parent(".bsm-placeholder").offset().left -
                                g / 2,
                              top:
                                t(document).scrollTop() +
                                c / 2 -
                                a.parent(".bsm-placeholder").offset().top -
                                v / 2,
                            },
                            {
                              duration: 275,
                ...
                t(window).on("scroll.bsmbox", function () {
                  o && e();
                }),
                t(window).on("resize.bsmbox", function () {
                  o && e();
                }),
                t(document).on("keyup.bsmbox", function (t) {
      ...
      return this.each(function (i) {
        function n(i) {
          ...
          i && s.css("display", "block"),
            a > c &&
              l < c + u &&
              s.css("transform", "translate3D(-50%," + h + "px, 0)");
        }
        var o = t(this);
        o.addClass("parallax"),
          o
  ...
  (function (t) {
    var e = {
      init: function (e) {
        ...
        e = t.extend(i, e);
        var n = Bsmkit.objectSelectorString(t(this));
        return this.each(function (i) {
          var o,
            s,
            r,
            ...
            u = t(this),
            d = t(window).width(),
            h = u.find("li.bsm-tab a"),
            p = u.width(),
            f = t(),
            m = Math.max(p, u[0].scrollWidth) / h.length,
            g = (prev_index = 0),
            v = !1,
            y = function (t) {
              return Math.ceil(
          ...
          e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1),
            0 === (o = t(h.filter('[href="' + location.hash + '"]'))).length &&
              (o = t(this).find("li.bsm-tab a.active").first()),
            0 === o.length && (o = t(this).find("li.bsm-tab a").first()),
            o.addClass("active"),
            (g = h.index(o)) < 0 && (g = 0),
            void 0 !== o[0] && (s = t(o[0].hash)).addClass("active"),
            u.find(".indicator").length ||
              u.append('<li class="bsm-indicator"></li>'),
            (a = u.find(".bsm-indicator")),
            u.append(a),
            u.is(":visible") &&
              setTimeout(function () {
                a.css({ right: y(o) }), a.css({ left: _(o) });
              }, 0),
            t(window)
              .off("resize.tabs-" + c)
              .on("resize.tabs-" + c, function () {
                (p = u.width()),
                  (m = Math.max(p, u[0].scrollWidth) / h.length),
                  g < 0 && (g = 0),
                  0 !== m &&
            ...
            e.swipeable
              ? (h.each(function () {
                  var e = t(Bsmkit.escapeHash(this.hash));
                  e.addClass("bsm-carousel-item"), (f = f.add(e));
                }),
                (r = f.wrapAll(
                  '<div class="bsm-tabs-content carousel"></div>'
                )),
                f.css("display", ""),
                t(".bsm-tabs-content.carousel").carousel({
                  fullWidth: !0,
                  noWrap: !0,
                  onCycleTo: function (t) {
                    if (!v) {
                      ...
                      (g = r.index(t)),
                        ...
                        (o = h.eq(g)).addClass("active"),
                        b(i),
                        "function" == typeof e.onShow && e.onShow.call(u[0], s);
                    }
                  },
                }))
              : h.not(o).each(function () {
                  t(Bsmkit.escapeHash(this.hash)).hide();
                }),
            u.off("click.bsm-tabs").on("click.bsm-tabs", "a", function (i) {
              if (t(this).parent().hasClass("disabled")) i.preventDefault();
                ...
                var n = s;
                (o = t(this)),
                  (s = t(Bsmkit.escapeHash(this.hash))),
                  (h = u.find("li.bsm-tab a"));
                o.position();
                o.addClass("active"),
                  (prev_index = g),
                  (g = h.index(t(this))) < 0 && (g = 0),
                  e.swipeable
                    ? f.length &&
                      f.carousel("set", g, function () {
                        "function" == typeof e.onShow && e.onShow.call(u[0], s);
                      })
                    : (void 0 !== s &&
                        (s.show(),
  ...
  (function (t) {
            ...
            var s,
              ...
              d = function () {
                (s = o.attr("data-html")
                  ...
                  : i.html),
                  (r = o.attr("data-delay")),
                  (r = void 0 === r || "" === r ? i.delay : r),
                  (a = o.attr("data-position")),
                  (a = void 0 === a || "" === a ? i.position : a),
                  (l = o.attr("data-tooltip")),
                  (l = void 0 === l || "" === l ? i.tooltip : l);
              };
            d();
            (c = (function () {
              var e = t('<div class="bsm-tooltip"></div>');
              return (
                (l = s
                  ? t("<span></span>").html(l)
                  : t("<span></span>").text(l)),
                e.append(l).appendTo(t("body")).attr("id", n),
                (u = t('<div class="bsm-backdrop"></div>')).appendTo(e),
                e
              );
            })()),
              o.off("mouseenter.bsm-tooltip mouseleave.tooltip");
            var h,
              p = !1;
            o.on({
                ...
                h = setTimeout(function () {
                  ...
                  "top" === a
                    ...
                    : ((t = o.offset().top + o.outerHeight() + 5),
                      ...
                      (n = e(i, t, h, l)),
                      (f = "+10px"),
                      u.css({ top: 0, left: 0, marginLeft: h / 2 - g / 2 })),
                    c.css({ top: n.y, left: n.x }),
                    (y = (Math.SQRT2 * h) / parseInt(g)),
                    (_ = (Math.SQRT2 * l) / parseInt(v)),
                    (b = Math.max(y, _)),
                    c
                      .velocity(
                        { translateY: f, translateX: m },
    ...
    var e = function (e, i, n, o) {
      ...
      return (
        ...
        r < 0
          ? (r = 4)
          : r + o > window.innerHeight + t(window).scrollTop &&
            (r -= r + o - window.innerHeight),
        { x: s, y: r }
      );
    };
    t(document).ready(function () {
      t(".bsm-tooltipped").tooltip();
    });
  })(jQuery),
  (function (t) {
    "use strict";
    ...
    var a = a || {},
      ...
      c = {
        ...
        show: function (t, e) {
          ...
          (s.className = "waves-ripple"), i.appendChild(s);
          var r = n(i),
            a = t.pageY - r.top,
            l = t.pageX - r.left,
            u = "scale(" + (i.clientWidth / 100) * 10 + ")";
          "touches" in t &&
            ((a = t.touches[0].pageY - r.top),
            (l = t.touches[0].pageX - r.left)),
        ...
        allowEvent: function (t) {
          ...
          return (
            "touchstart" === t.type
              ...
              : "mousedown" === t.type && u.touches > 0 && (e = !1),
            e
          );
        },
        touchup: function (t) {
  ...
  (function (t) {
            ...
            [
              {
                ...
                value: function () {
                  ...
                  if ((e.classList.add("bsm-toast"), this.options.className)) {
                    var n = this.options.className.split(" "),
                      o = void 0,
                      s = void 0;
                    for (o = 0, s = n.length; o < s; o++) e.classList.add(n[o]);
                  }
                  return (
                    (
            ...
            [
              {
                ...
                value: function () {
                  var t = document.createElement("div");
                  t.setAttribute("id", "bsm-toast-container"),
              ...
              },
              {
                ...
                value: function (t) {
                  if (i._draggedToast) {
                    ...
                    var n = e.xPos - e.startingXPos,
                      o = e.el.offsetWidth * e.options.activationPercent;
                    Math.abs(n) > o || e.velocityX > 1
                      ? ((e.wasSwiped = !0), e.remove())
                      : ((e.el.style.transition = "transform .2s, opacity .2s"),
                        (e.el.style.transform = null),
                        (e.el.style.opacity = null)),
    ...
    (i._toasts = []),
      (i._container = null),
      (i._draggedToast = null),
      (window.Bsmkit.Toast = i),
      (window.Bsmkit.toast = function (t, e, n, o) {
  ...
  (function (t) {
    var e = {
          ...
          t(this).each(function () {
            ...
            e.draggable
              ...
              o.hasClass("fixed") &&
                t(window).resize(function () {
                  window.innerWidth > 992
                    ? 0 !== t("#bsm-sidenav-overlay").length && l
                      ? r(!0)
                      : o.css("transform", "translateX(0%)")
                    : !1 === l &&
                      ("left" === e.edge
            ...
            var r = function (i) {
                (a = !1),
                  ...
                  t("#bsm-sidenav-overlay").velocity(
                    { opacity: 0 },
                    {
                      duration: 200,
                      queue: !1,
            ...
            e.draggable &&
                ...
                .on("pan", function (i) {
                  if ("touch" == i.gesture.pointerType) {
                    ...
                    var n = i.gesture.center.x,
                      s = i.gesture.center.y;
                    i.gesture.velocityX;
                    if (0 === n && 0 === s) return;
                    var a = t("body"),
                      c = t("#bsm-sidenav-overlay"),
                      u = a.innerWidth();
                    if (
                      (a.css("overflow", "hidden"),
                      a.width(u),
                      0 === c.length &&
                        ((c = t('<div id="bsm-sidenav-overlay"></div>'))
                          .css("opacity", 0)
                          .click(function () {
                            r();
                          }),
                      ...
                      n < e.menuWidth / 2
                        ...
                        o.css(
                          "transform",
                          "translateX(" + (n - e.menuWidth) + "px)"
                        );
                    else {
                      n < window.innerWidth - e.menuWidth / 2
                        ? (l = !0)
                        : n >= window.innerWidth - e.menuWidth / 2 && (l = !1);
                    ...
                    "left" === e.edge
                      ...
                      : ((h = Math.abs((n - window.innerWidth) / e.menuWidth)),
                        c.velocity(
                          { opacity: h },
                          { duration: 10, queue: !1, easing: "easeOutQuad" }
                        ));
              ...
              i.off("click.sidenav").on("click.sidenav", function () {
                if (!0 === l) (l = !1), (a = !1), r();
                  ...
                  var i = t("body"),
                    n = t('<div id="bsm-sidenav-overlay"></div>'),
                    c = i.innerWidth();
      ...
      hide: function () {
        t("#bsm-sidenav-overlay").trigger("click");
      },
    };
  ...
  (function (t) {
    ...
    function i(i) {
      ...
      var n = o.scrollTop(),
        ...
        a = s + o.width(),
        u = n + o.height(),
        d = e(n + c.top + i || 200, a + c.right, u + c.bottom, s + c.left);
      t.each(d, function (t, e) {
        "number" != typeof e.data("bsmScrollSpy:ticks") &&
          e.triggerHandler("bsmScrollSpy:enter"),
          e.data("bsmScrollSpy:ticks", l);
      }),
        t.each(r, function (t, e) {
          var i = e.data("bsmScrollSpy:ticks");
          "number" == typeof i &&
            i !== l &&
            (e.triggerHandler("bsmScrollSpy:exit"),
            e.data("bsmScrollSpy:ticks", null));
        }),
        (r = d);
    }
    function n() {
      o.trigger("bsmScrollSpy:winSize");
    }
    var o = t(window),
      s = [],
      r = [],
    ...
    (t.bsmScrollSpy = function (e, n) {
      ...
      (e = t(e)).each(function (e, i) {
        s.push(t(i)),
          t(i).data("bsmScrollSpy:id", e),
          t('a[href="#' + t(i).attr("id") + '"]').click(function (e) {
            e.preventDefault();
            var i = t(Bsmkit.escapeHash(this.hash)).offset().top + 1;
            t("html, body").animate(
      ...
      var u = Bsmkit.throttle(function () {
          i(n.scrollOffset);
        }, n.throttle || 100),
        d = function () {
          t(document).ready(u);
      ...
      return (
        a || (o.on("scroll", d), o.on("resize", d), (a = !0)),
        setTimeout(d, 0),
        e.on("bsmScrollSpy:enter", function () {
          l = t.grep(l, function (t) {
            return 0 != t.height();
          });
          var e = t(this);
          l[0]
            ? (t(n.getActiveElement(l[0].attr("id"))).removeClass(
                n.activeClass
              ),
              e.data("bsmScrollSpy:id") < l[0].data("bsmScrollSpy:id")
                ? l.unshift(t(this))
                : l.push(t(this)))
            : l.push(t(this)),
            t(n.getActiveElement(l[0].attr("id"))).addClass(n.activeClass);
        }),
        e.on("bsmScrollSpy:exit", function () {
          if (
            (l = t.grep(l, function (t) {
              return 0 != t.height();
            }))[0]
      ...
      (t.winSizeSpy = function (e) {
        return (
          ...
          (e = e || { throttle: 100 }),
          o.on("resize", Bsmkit.throttle(n, e.throttle || 100))
        );
      }),
      (t.fn.bsmScrollSpy = function (e) {
        return t.bsmScrollSpy(t(this), e);
      });
  })(jQuery),
  (function (t) {
    t(document).ready(function () {
      ...
      n.length ||
        ((n = t('<div class="hiddendiv common"></div>')), t("body").append(n));
      t(".Bsmkit-textarea").each(function () {
        var e = t(this);
          ...
          function (e) {
            ...
            if (s) {
              ...
              i.addClass("active").css("left", l),
                i.find(".value").html(i.siblings(o).val());
            }
          }
        ),
          ...
          return (
            ...
            this.each(function () {
              ...
              if (t.isEmptyObject(o))
                n.off("keyup.autocomplete focus.autocomplete");
              else {
                var l,
                  c = t(
                    '<ul class="autocomplete-content bsm-dropdown-content"></ul>'
                  );
                a.length
                  ? (l = a
                      .children(".autocomplete-content.bsm-dropdown-content")
                      .first()).length || a.append(c)
                  : (l = n.next(".autocomplete-content.bsm-dropdown-content"))
                      .length || n.after(c),
                  l.length && (c = l);
                var u = function (t, e) {
                    var i = e.find("img"),
                ...
                n.off("blur.autocomplete").on("blur.autocomplete", function () {
                  ...
                  n
                    ...
                    .on("keyup.autocomplete focus.autocomplete", function (r) {
                      s = 0;
                      var a = n.val().toLowerCase();
                      if (13 !== r.which && 38 !== r.which && 40 !== r.which) {
                        if (i !== a && (h(), a.length >= e.minLength))
                          for (var l in o)
                            if (
                              o.hasOwnProperty(l) &&
                              -1 !== l.toLowerCase().indexOf(a)
                            ) {
                              if (s >= e.limit) break;
                              var d = t("<li></li>");
                              o[l]
                    ...
                    .on("keydown.autocomplete", function (t) {
                      ...
                      13 === i && r >= 0
                        ...
                        : (38 !== i && 40 !== i) ||
                          ...
                          40 === i && r < n - 1 && r++,
                          o.removeClass("active"),
                          r >= 0 && c.children("li").eq(r).addClass("active"));
                    }),
                  c
      ...
      (t.fn.bsm_select = function (e) {
        function i(t, e, i) {
          var o = t.indexOf(e),
            s = -1 === o;
          return (
            s ? t.push(e) : t.splice(o, 1),
            i
              .siblings("ul.bsm-dropdown-content")
              .find("li:not(.optgroup)")
              .eq(e)
              .toggleClass("active"),
            i.find("option").eq(e).prop("selected", s),
            n(t, i),
            s
          );
        }
        ...
        t(this).each(function () {
          ...
          if (!n.hasClass("browser-default")) {
            ...
            if (
              ...
              return (
                n.removeAttr("data-select-id").removeClass("initialized"),
                void t(window).off("click.select")
              );
            var r = Bsmkit.guid();
            n.attr("data-select-id", r);
            var a = t('<div class="bsm-select-wrapper"></div>');
            a.addClass(n.attr("class")),
              n.is(":disabled") && a.addClass("disabled");
            var l = t(
                '<ul id="select-options-' +
                  r +
                  '" class="bsm-dropdown-content select-dropdown ' +
            ...
            c.length &&
              c.each(function () {
                if (t(this).is("option"))
                  o ? p(0, t(this), "multiple") : p(0, t(this));
                  ...
                  if (
                    ...
                    o
                      ...
                      : (l.find("li").removeClass("active"),
                        ...
                        g.val(t(this).text())),
                      v(l, t(this)),
                      n.find("option").eq(s).prop("selected", a),
                      n.trigger("change"),
                      void 0 !== e && e();
                  }
                  r.stopPropagation();
            ...
            n.before(g),
              ...
              g.on("blur", function () {
                o || (t(this).trigger("close"), t(window).off("click.select")),
                    ...
                    if (i && -1 === n.indexOf(e.which)) {
                      ...
                      var s = y.join(""),
                        r = l.find("li").filter(function () {
                          return 0 === t(this).text().toLowerCase().indexOf(s);
                        })[0];
                      r && v(l, r);
                    }
                    if (13 == e.which) {
      ...
      init: function (e) {
        ...
        return (
          ...
          this.each(function () {
            ...
            function n(t) {
              t >= c.length ? (t = 0) : t < 0 && (t = c.length - 1),
                (u = l.find(".active").index()) != t &&
                  ...
                  e.indicators && s.eq(u).removeClass("active"),
                  c.eq(t).velocity(
                    { opacity: 1 },
                    {
                      duration: e.transition,
            ...
            -1 != u && (o = c.eq(u)),
              a.hasClass("fullscreen") ||
                (e.indicators ? a.height(e.height + 40) : a.height(e.height),
                l.height(e.height)),
              ...
              e.indicators &&
                ((s = t('<ul class="bsm-indicators"></ul>')),
                c.each(function (i) {
                  var o = t('<li class="bsm-indicator-item"></li>');
                  o.click(function () {
                ...
                a.append(s),
                (s = a
                  .find("ul.bsm-indicators")
                  .find("li.bsm-indicator-item"))),
              o
                ? o.show()
                : (c.first().addClass("active").velocity(
                    { opacity: 1 },
                    {
                      duration: e.transition,
                      queue: !1,
                  ...
                  (u = 0),
                  (o = c.eq(u)),
                  e.indicators && s.eq(u).addClass("active")),
            ...
            a
              ...
              .on("pan", function (t) {
                if ("touch" === t.gesture.pointerType) {
                  ...
                  var s;
                  h &&
                    (0 === (s = $curr_slide.next()).length && (s = c.first()),
                    s.velocity(
                      { opacity: 1 },
                      { duration: 300, queue: !1, easing: "easeOutQuad" }
                    )),
                    p &&
                      (0 === (s = $curr_slide.prev()).length && (s = c.last()),
                      s.velocity(
                        { opacity: 1 },
                        { duration: 300, queue: !1, easing: "easeOutQuad" }
                      ));
        ...
        (n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data)),
            ...
            n.$document
                ...
                .on("keydown.chips", function (i) {
                  if (!t(i.target).is("input, textarea")) {
                    var o,
                      ...
                      r = s.closest(e.CHIPS),
                      a = s.siblings(e.CHIP).length;
                    if (s.length)
                      if (8 === i.which || 46 === i.which) {
                        i.preventDefault(), (o = s.index()), n.deleteChip(o, r);
                        var l = null;
                        o + 1 < a
                          ? (l = o)
                          : (o !== a && o + 1 !== a) || (l = a - 1),
                          l < 0 && (l = null),
                          null !== l && n.selectChip(l, r),
                          a || r.find("input").focus();
                      } else if (37 === i.which) {
              ...
              n.$document
                ...
                .on("focusout.chips", e.CHIPS + " " + e.INPUT, function (i) {
                  var n = t(i.target).closest(e.CHIPS);
                  n.removeClass("focus"),
                    (void 0 !== n.data("chips") && n.data("chips").length) ||
                      n.siblings("label").removeClass("active"),
              ...
              n.$document
                ...
                .on("keydown.chips-add", e.CHIPS + " " + e.INPUT, function (i) {
                  var o = t(i.target),
                    s = o.closest(e.CHIPS),
                    r = s.children(e.CHIP).length;
                  if (13 === i.which) {
                    if (
                      n.hasAutocomplete &&
                      s.find(".autocomplete-content.bsm-dropdown-content")
                        .length &&
                      s
                        .find(".autocomplete-content.bsm-dropdown-content")
                        .children().length
                    )
                      return;
                    return (
                  ...
                  if (
                    ...
                    return (
                      i.preventDefault(), n.selectChip(r - 1, s), void o.blur()
                    );
                }),
              n.$document
          ...
          (this.renderChip = function (e) {
            if (e.tag) {
              ...
              return (
                i.text(e.tag),
                e.image && i.prepend(t("<img />").attr("src", e.image)),
          ...
          (this.setPlaceholder = function (t) {
            ...
            o.placeholder
              ...
              : (void 0 === t.data("chips") || t.data("chips").length) &&
          ...
          (this.addChip = function (t, e) {
            if (n.isValid(e, t)) {
              for (
                var i = n.renderChip(t), o = [], s = e.data("chips"), r = 0;
                r < s.length;
                r++
              )
                o.push(s[r]);
          ...
          (this.deleteChip = function (t, e) {
            ...
            for (var o = [], s = e.data("chips"), r = 0; r < s.length; r++)
              r !== t && o.push(s[r]);
            e.data("chips", o),
    ...
    var e = function (e) {
        ...
        if (!1 === i.hasClass("active")) {
          ...
          !0 === i.hasClass("horizontal") ? (o = 40) : (n = 40),
            i.addClass("active"),
            i.find("ul .bsm-btn-floating").velocity(
              {
                scaleY: ".4",
                scaleX: ".4",
                translateY: n + "px",
      ...
      i = function (t) {
        ...
        n.find("ul .bsm-btn-floating").velocity("stop", !0),
          n.find("ul .bsm-btn-floating").velocity(
            {
              opacity: "0",
              scaleX: ".4",
              scaleY: ".4",
      ...
      n = function (e) {
        if ("true" !== e.attr("data-open")) {
          var i,
            ...
            h = c.css("background-color");
          c.append(d),
            (i = l.left - r / 2 + l.width / 2),
            (n = a - l.bottom),
            (s = r / d.width()),
            ...
            setTimeout(function () {
              e.css({
                ...
                setTimeout(function () {
                  e.css({ overflow: "hidden", "background-color": h }),
                    d.css({
                      transform: "scale(" + s + ")",
                      transition:
  ...
  (function (t) {
    (Bsmkit.fadeInImage = function (e) {
      ...
      (Bsmkit.showStaggeredList = function (e) {
        var i;
        if ("string" == typeof e) i = t(e);
        else {
          if ("object" != typeof e) return;
          ...
          t(this)
            ...
            .on("pan", function (n) {
              if ("touch" === n.gesture.pointerType) {
                ...
                o.velocity(
                  ...
                  4 === s && (r > o.innerWidth() / 2 || a < -0.75) && (e = !0),
                  2 === s &&
                    (r < (-1 * o.innerWidth()) / 2 || a > 0.75) &&
                    (i = !0);
              }
            })
            .on("panend", function (n) {
              if (
                ...
                if (e || i) {
                  var s;
                  (s = e ? o.innerWidth() : -1 * o.innerWidth()),
                    o.velocity(
                      { translateX: s },
                      {
                        duration: 100,
    ...
    Bsmkit.scrollFire = function (t) {
      var i = function () {
          for (
            ...
            null !== a &&
              e > a.getBoundingClientRect().top + window.pageYOffset + s &&
              !0 !== n.done &&
              ("function" == typeof r
                ? r.call(this, a)
  ...
  (function (t) {
    ...
    function e(s, a, u, d) {
      function h() {
        return e._.node(
          ...
          e._.node(
            ...
            e._.node(
              "div",
              e._.node("div", E.component.nodes(_.open), w.box),
              w.wrap
            ),
            w.frame
          ),
      ...
      function p() {
        C.data(a, E)
          .addClass(w.input)
          .attr("tabindex", -1)
          .val(C.data("value") ? E.get("select", b.format) : s.value),
          b.editable ||
            C.on("focus." + _.id + " click." + _.id, function (t) {
              t.preventDefault(), E.$root.eq(0).focus();
            }).on("keydown." + _.id, g),
          o(s, {
            haspopup: !0,
            expanded: !1,
      ...
      function f() {
        E.$root
          .on({
            keydown: g,
            focusin: function (t) {
              E.$root.removeClass(w.focused), t.stopPropagation();
            },
            "mousedown click": function (e) {
              ...
              i != E.$root.children()[0] &&
                ...
                "mousedown" != e.type ||
                  ...
                  (e.preventDefault(), E.$root.eq(0).focus()));
            },
          })
          .on({
            focus: function () {
          ...
          .on(
            ...
            function () {
              var e = t(this),
                ...
                o = r();
              (o = o && (o.type || o.href)),
                (n || (o && !t.contains(E.$root[0], o))) &&
                  E.$root.eq(0).focus(),
                !n && i.nav
                  ? E.set("highlight", E.component.item.highlight, {
                      nav: i.nav,
                    })
                  : !n && "pick" in i
                  ? (E.set("select", i.pick), b.closeOnSelect && E.close(!0))
                  : i.clear
                  ? (E.clear(), b.closeOnSelect && E.close(!0))
                  : i.close && E.close(!0);
            }
          ),
          o(E.$root[0], "hidden", !0);
          ...
          (E._hidden = t(
            '<input type=hidden name="' +
              ...
              (C.data("value") || s.value
                ? ' value="' + E.get("select", b.formatSubmit) + '"'
                : "") +
              ">"
          )[0]),
          C.on("change." + _.id, function () {
            E._hidden.value = s.value ? E.get("select", b.formatSubmit) : "";
          }),
          b.container ? t(b.container).append(E._hidden) : C.before(E._hidden);
      }
      function g(t) {
        var e = t.keyCode,
          i = /^(8|46)$/.test(e);
        if (27 == e) return E.close(), !1;
        (32 == e || i || (!_.open && E.component.key[e])) &&
          (t.preventDefault(),
          t.stopPropagation(),
      ...
      function v(t) {
        t.stopPropagation(),
          "focus" == t.type && E.$root.addClass(w.focused),
          E.open();
      }
      if (!s) return e;
      var y = !1,
        _ = { id: s.id || "P" + Math.abs(~~(Math.random() * new Date())) },
        b = u ? t.extend(!0, {}, u.defaults, d) : d || {},
        w = t.extend({}, e.klasses(), b.klass),
        C = t(s),
        T = function () {
          return this.start();
        },
        E = (T.prototype = {
          ...
          start: function () {
            return _ && _.start
              ...
              : ((_.methods = {}),
                ...
                (_.type = s.type),
                (s.autofocus = s == r()),
                (s.readOnly = !b.editable),
                (s.id = s.id || _.id),
                "text" != s.type && (s.type = "text"),
                (E.component = new u(E, b)),
                (E.$root = t(
                  e._.node(
                    "div",
                    h(),
                    w.picker,
                    'id="' + s.id + '_root" tabindex="0"'
                  )
                )),
                f(),
                b.formatSubmit && m(),
          ...
          render: function (t) {
            return (
              t
                ? E.$root.html(h())
                : E.$root.find("." + w.box).html(E.component.nodes(_.open)),
              E.trigger("render")
            );
          },
          stop: function () {
            return _.start
              ? (E.close(),
                E._hidden && E._hidden.parentNode.removeChild(E._hidden),
                E.$root.remove(),
          ...
          open: function (i) {
            return _.open
              ...
              : (C.addClass(w.active),
                o(s, "expanded", !0),
                setTimeout(function () {
                  E.$root.addClass(w.opened), o(E.$root[0], "hidden", !1);
                }, 0),
                !1 !== i &&
                  ((_.open = !0),
                  y &&
                  ...
                  E.$root.eq(0).focus(),
                  l
                    .on("click." + _.id + " focusin." + _.id, function (t) {
                      var e = t.target;
                      e != s &&
                        e != document &&
                        3 != t.which &&
                        E.close(e === E.$root.children()[0]);
                    })
                    .on("keydown." + _.id, function (i) {
                      ...
                      27 == n
                        ? E.close(!0)
                        : s != E.$root[0] || (!o && 13 != n)
                        ? t.contains(E.$root[0], s) &&
                          13 == n &&
                          (i.preventDefault(), s.click())
                        : (i.preventDefault(),
                          o
                            ? e._.trigger(E.component.key.go, E, [
                                e._.trigger(o),
                              ])
                            : E.$root
                                .find("." + w.highlighted)
                                .hasClass(w.disabled) ||
                              (E.set("select", E.component.item.highlight),
                              b.closeOnSelect && E.close(!0)));
                    })),
                E.trigger("open"));
          },
          close: function (t) {
            return (
              t &&
                (E.$root.off("focus.toOpen").eq(0).focus(),
                setTimeout(function () {
                  E.$root.on("focus.toOpen", v);
                }, 0)),
              C.removeClass(w.active),
              o(s, "expanded", !1),
              setTimeout(function () {
                E.$root.removeClass(w.opened + " " + w.focused),
                  o(E.$root[0], "hidden", !0);
              }, 0),
              _.open
                ? ((_.open = !1),
                  y && c.css("overflow", "").css("padding-right", "-=" + n()),
                  l.off("." + _.id),
                  E.trigger("close"))
                : E
            );
              ...
              for (o in a)
                (s = a[o]),
                  o in E.component.item &&
                    (void 0 === s && (s = null), E.component.set(o, s, n)),
                  ("select" != o && "clear" != o) ||
                    C.val("clear" == o ? "" : E.get(o, b.format)).trigger(
                      "change"
                    );
              E.render();
            }
          ...
          get: function (t, i) {
            ...
            if (t in E.component.item) {
              if ("string" == typeof i) {
                var n = E.component.get(t);
                return n
                  ? e._.trigger(E.component.formats.toString, E.component, [
                      i,
                      n,
                    ])
                  : "";
          ...
          off: function () {
            ...
            for (t = 0, namesCount = i.length; t < namesCount; t += 1)
              (e = i[t]) in _.methods && delete _.methods[e];
            return E;
          },
    ...
    function i(t) {
      ...
      return (
        t.currentStyle
          ? (e = t.currentStyle.position)
          : window.getComputedStyle && (e = getComputedStyle(t).position),
        "fixed" == e
      );
    }
    function n() {
    ...
    function o(e, i, n) {
      if (t.isPlainObject(i)) for (var o in i) s(e, o, i[o]);
      else s(e, i, n);
    }
    function s(t, e, i) {
    ...
    (function (t, e) {
      ...
      function s(t, e) {
        var i = this,
          ...
          l = function () {
            return n.currentStyle
              ? n.currentStyle.direction == "rtl"
              : getComputedStyle(t.$root[0]).direction == "rtl";
          };
        i.settings = e;
        i.$node = t.$node;
        i.queue = {
        ...
        i.item.enable = -(function (t) {
          return t[0] === true ? t.shift() : -1;
        })(i.item.disable);
        i.set("min", e.min).set("max", e.max).set("now");
        if (r) {
          i.set("select", r, { format: a });
        } else {
        ...
        t.on(
          ...
          .on(
            ...
            function () {
              var n = "";
              if (i.disabled(i.get("now"))) {
                n = ":not(." + e.klass.buttonToday + ")";
              }
              t.$root.find("button" + n + ", select").attr("disabled", false);
            },
            1
          )
          .on(
            "close",
            function () {
              t.$root.find("button, select").attr("disabled", true);
            },
            1
          );
      }
      s.prototype.set = function (t, e, i) {
        ...
        o[t == "enable" ? "disable" : t == "flip" ? "enable" : t] = n.queue[t]
          .split(" ")
          .map(function (o) {
            e = n[o](t, e, i);
            return e;
        ...
        } else if (t.match(/^(flip|min|max|disable|enable)$/)) {
          if (o.select && n.disabled(o.select)) {
            n.set("select", o.select, i);
          }
          if (o.highlight && n.disabled(o.highlight)) {
      ...
      s.prototype.create = function (t, i, n) {
        var s,
          r = this;
        i = i === undefined ? t : i;
        if (i == -Infinity || i == Infinity) {
          s = i;
        } else if (e.isPlainObject(i) && o.isInteger(i.pick)) {
          i = i.obj;
        } else if (e.isArray(i)) {
          i = new Date(i[0], i[1], i[2]);
          i = o.isDate(i) ? i : r.create().obj;
        } else if (o.isInteger(i) || o.isDate(i)) {
          i = r.normalize(new Date(i), n);
        } else {
          i = r.now(t, i, n);
        }
        return {
      ...
      s.prototype.createRange = function (t, i) {
        var n = this,
          s = function (t) {
            if (t === true || e.isArray(t) || o.isDate(t)) {
              return n.create(t);
            }
            return t;
          };
        ...
        if (o.isInteger(t) && e.isPlainObject(i)) {
          t = [i.year, i.month, i.date + t];
        } else if (o.isInteger(i) && e.isPlainObject(t)) {
          i = [t.year, t.month, t.date + i];
        }
        return { from: s(t), to: s(i) };
      };
      s.prototype.withinRange = function (t, e) {
        t = this.createRange(t.from, t.to);
        return e.pick >= t.from.pick && e.pick <= t.to.pick;
      };
      s.prototype.overlapRanges = function (t, e) {
        var i = this;
      ...
      s.prototype.now = function (t, e, i) {
        e = new Date();
        if (i && i.rel) {
          e.setDate(e.getDate() + i.rel);
        }
        return this.normalize(e, i);
      };
      s.prototype.navigate = function (t, i, n) {
        var o,
          s,
          r,
          a,
        ...
        if (l || c) {
          ...
          if (n && n.nav && u && u.month !== r) {
            s = u.year;
            r = u.month;
          }
          o = new Date(s, r + (n && n.nav ? n.nav : 0), 1);
          s = o.getFullYear();
          r = o.getMonth();
          while (new Date(s, r, a).getMonth() !== r) {
            a -= 1;
          }
          i = [s, r, a];
        }
      ...
      s.prototype.measure = function (t, e) {
        var i = this;
        if (!e) {
          e = t == "min" ? -Infinity : Infinity;
        } else if (typeof e == "string") {
          e = i.parse(t, e);
        } else if (o.isInteger(e)) {
          e = i.now(t, e, { rel: e });
        }
        return e;
      };
      s.prototype.viewset = function (t, e) {
        return this.create([e.year, e.month, 1]);
      };
      s.prototype.validate = function (t, i, n) {
        var s = this,
          r = i,
          a = n && n.interval ? n.interval : 1,
          l = s.item.enable === -1,
          c,
          u,
          d = s.item.min,
          ...
          m =
            l &&
            s.item.disable.filter(function (t) {
              if (e.isArray(t)) {
                var n = s.create(t).pick;
                if (n < i.pick) c = true;
                else if (n > i.pick) u = true;
              }
        ...
        if (!n || !n.nav)
          if (
            (!l && s.disabled(i)) ||
            (l && s.disabled(i) && (m || c || u)) ||
            (!l && (i.pick <= d.pick || i.pick >= h.pick))
          ) {
            if (l && !m && ((!u && a > 0) || (!c && a < 0))) {
              a *= -1;
            }
            while (s.disabled(i)) {
              if (Math.abs(a) > 1 && (i.month < r.month || i.month > r.month)) {
                i = r;
                a = a > 0 ? 1 : -1;
              }
              if (i.pick <= d.pick) {
                ...
                i = s.create([
                  d.year,
                  d.month,
                  d.date + (i.pick === d.pick ? 0 : -1),
                ]);
              } else if (i.pick >= h.pick) {
                f = true;
                a = -1;
                i = s.create([
                  h.year,
              ...
              i = s.create([i.year, i.month, i.date + a]);
            }
          }
        return i;
      };
      s.prototype.disabled = function (t) {
        var i = this,
          n = i.item.disable.filter(function (n) {
            if (o.isInteger(n)) {
              return t.day === (i.settings.firstDay ? n : n - 1) % 7;
            }
            if (e.isArray(n) || o.isDate(n)) {
              return t.pick === i.create(n).pick;
            }
            if (e.isPlainObject(n)) {
              return i.withinRange(n, t);
            }
          });
        n =
          n.length &&
          !n.filter(function (t) {
            return (
              (e.isArray(t) && t[3] == "inverted") ||
              (e.isPlainObject(t) && t.inverted)
            );
          }).length;
        return i.item.enable === -1
          ? !n
      ...
      s.prototype.parse = function (t, e, i) {
        ...
        n.formats.toArray(i.format).map(function (t) {
          var i = n.formats[t],
            r = i ? o.trigger(i, n, [e, s]) : t.replace(/^!/, "").length;
          if (i) {
            s[t] = e.substr(0, r);
          }
          e = e.substr(r);
        });
        return [s.yyyy || s.yy, +(s.mm || s.m) - 1, s.dd || s.d];
      };
      ...
      s.prototype.isDateExact = function (t, i) {
        var n = this;
        if (
          (o.isInteger(t) && o.isInteger(i)) ||
          (typeof t == "boolean" && typeof i == "boolean")
        ) {
          return t === i;
        }
        if ((o.isDate(t) || e.isArray(t)) && (o.isDate(i) || e.isArray(i))) {
          return n.create(t).pick === n.create(i).pick;
        }
        if (e.isPlainObject(t) && e.isPlainObject(i)) {
          return n.isDateExact(t.from, i.from) && n.isDateExact(t.to, i.to);
        }
        return false;
      };
      s.prototype.isDateOverlap = function (t, i) {
        var n = this,
          s = n.settings.firstDay ? 1 : 0;
        if (o.isInteger(t) && (o.isDate(i) || e.isArray(i))) {
          t = (t % 7) + s;
          return t === n.create(i).day + 1;
        }
        if (o.isInteger(i) && (o.isDate(t) || e.isArray(t))) {
          i = (i % 7) + s;
          return i === n.create(t).day + 1;
        }
        if (e.isPlainObject(t) && e.isPlainObject(i)) {
          return n.overlapRanges(t, i);
        }
        return false;
      };
      s.prototype.flipEnable = function (t) {
        var e = this.item;
      ...
      s.prototype.activate = function (t, i) {
        ...
        if (i == "flip") {
          ...
          i.map(function (t) {
            ...
            for (l = 0; l < r; l += 1) {
              a = s[l];
              if (n.isDateExact(a, t)) {
                i = s[l] = null;
                c = true;
                break;
              } else if (n.isDateOverlap(a, t)) {
                if (e.isPlainObject(t)) {
                  t.inverted = true;
                  i = t;
                } else if (e.isArray(t)) {
                  i = t;
                  if (!i[3]) i.push("inverted");
                } else if (o.isDate(t)) {
                  i = [t.getFullYear(), t.getMonth(), t.getDate(), "inverted"];
                }
                break;
              }
            }
      ...
      s.prototype.nodes = function (t) {
        var e = this,
          ...
          f = (function (t, e) {
            ...
            (s.showWeekdaysFull ? s.weekdaysFull : s.weekdaysLetter).slice(0),
            s.weekdaysFull.slice(0)
          ),
          m = function (t) {
            return o.node(
              "div",
              ...
              s.klass["nav" + (t ? "Next" : "Prev")] +
                ((t && u.year >= p.year && u.month >= p.month) ||
                (!t && u.year <= h.year && u.month <= h.month)
                  ? " " + s.klass.navDisabled
                  : ""),
              "data-nav=" +
                (t || -1) +
          ...
          g = function (i) {
            var n = s.showMonthsShort ? s.monthsShort : s.monthsFull;
            if (i == "short_months") {
              n = s.monthsShort;
            }
            if (s.selectMonths && i == undefined) {
              return o.node(
                "select",
                o.group({
                  min: 0,
                  ...
                  item: function (t) {
                    return [
                      ...
                      "value=" +
                        t +
                        (u.month == t ? " selected" : "") +
                        ((u.year == h.year && t < h.month) ||
                        (u.year == p.year && t > p.month)
                          ? " disabled"
                          : ""),
                    ];
                  },
                ...
                (t ? "" : "disabled") +
                  " " +
                  o.ariaAttr({ controls: e.$node[0].id + "_table" }) +
                  " " +
                  'title="' +
                  s.labelMonthSelect +
                  '"'
            ...
            if (i == "short_months")
              if (l != null) return n[l.month];
              else return n[u.month];
            return o.node("div", n[u.month], s.klass.month);
          },
          v = function (i) {
            var n = u.year,
              r = s.selectYears === true ? 5 : ~~(s.selectYears / 2);
            if (r) {
              var a = h.year,
                l = p.year,
                c = n - r,
            ...
            if (i == "raw") return o.node("div", n);
            return o.node("div", n, s.klass.year);
          };
        createDayLabel = function () {
          if (l != null) return l.date;
          else return a.date;
        };
        createWeekdayLabel = function () {
          ...
          var e = s.weekdaysShort[t];
          return e;
        };
        return (
          o.node(
            "div",
            o.node("div", v("raw"), s.klass.year_display) +
              o.node(
                "span",
                createWeekdayLabel() + ", ",
                "picker__weekday-display"
              ) +
              o.node("span", g("short_months") + " ", s.klass.month_display) +
              o.node("span", createDayLabel(), s.klass.day_display),
                    ...
                    o.node(
                      ...
                      o.group({
                        ...
                        item: function (t) {
                          var n =
                            s.firstDay &&
                            e.create([u.year, u.month, 1]).day === 0
                              ? -7
                              : 0;
                          return [
                            o.group({
                              ...
                              item: function (t) {
                                ...
                                var i = l && l.pick == t.pick,
                                  ...
                                  r =
                                    ...
                                    t.pick < h.pick ||
                                    t.pick > p.pick,
                                  f = o.trigger(e.formats.toString, e, [
                                    s.format,
                                    t,
                                  ]);
                                return [
                                  o.node(
                                    ...
                                    (function (e) {
                                      ...
                                      if (i) {
                                        e.push(s.klass.selected);
                                      }
                                      if (n) {
                                        e.push(s.klass.highlighted);
                                      }
                                      if (r) {
                                        e.push(s.klass.disabled);
                                      }
                                      return e.join(" ");
                                    })([s.klass.day]),
                                    "data-pick=" +
                                      ...
                                      o.ariaAttr({
                                        ...
                                        selected:
                                          i && e.$node.val() === f
                                            ? true
                                            : null,
                                        activedescendant: n ? true : null,
                                        disabled: r ? true : null,
                                      }) +
                                      " " +
                                      (r ? "" : 'tabindex="0"')
                                  ),
              ...
              o.node(
                ...
                o.node(
                  ...
                  "type=button data-pick=" +
                    a.pick +
                    (t && !e.disabled(a) ? "" : " disabled") +
                    " " +
                    o.ariaAttr({ controls: e.$node[0].id })
                ) +
                  o.node(
                    "button",
                    s.clear,
      ...
      t.extend("pickadate", s);
    })(Bsmkit.Picker, jQuery);
  })(),
  (function () {
    function t(t) {
    ...
    function n(n, r) {
      function l(t, e) {
        var i = d.offset(),
          ...
          c = (n ? t.originalEvent.touches[0] : t).pageY - s,
          u = Math.sqrt(l * l + c * c),
          h = !1;
        if (!e || !(u < y - b || u > y + b)) {
          t.preventDefault();
          ...
          I.setHand(l, c, !e, !0),
            a.off(p).on(p, function (t) {
              t.preventDefault();
              var e = /^touch/.test(t.type),
                i = (e ? t.originalEvent.touches[0] : t).pageX - o,
                n = (e ? t.originalEvent.touches[0] : t).pageY - s;
              (h || i !== l || n !== c) && ((h = !0), I.setHand(i, n, !1, !0));
            }),
            a.off(f).on(f, function (t) {
              a.off(f), t.preventDefault();
              var i = /^touch/.test(t.type),
                n = (i ? t.originalEvent.changedTouches[0] : t).pageX - o,
                u = (i ? t.originalEvent.changedTouches[0] : t).pageY - s;
              (e || h) && n === l && u === c && I.setHand(n, u),
                "hours" === I.currentView
                  ? I.toggleView("minutes", C / 2)
                  : r.autoclose &&
                    (I.minutesView.addClass("clockpicker-dial-out"),
                    setTimeout(function () {
                      I.done();
                    }, C / 2)),
                d.prepend(M),
                clearTimeout(m),
                I.popover.removeClass("clockpicker-moving"),
                a.off(p);
            });
        }
      }
      var u = s(T),
        ...
        E = u.find(".clockpicker-minutes"),
        x = u.find(".clockpicker-am-pm-block"),
        k = "INPUT" === n.prop("tagName"),
        S = k ? n : n.find("input"),
        A = s("label[for=" + S.attr("id") + "]"),
        I = this;
      (this.id = i("cp")),
        (this.element = n),
        (this.holder = m),
        ...
        r.twelvehour &&
          (r.ampmclickable
            ? (this.spanAmPm.empty(),
              s('<div id="click-am">AM</div>')
                .on("click", function () {
                  I.spanAmPm.children("#click-am").addClass("text-primary"),
                    I.spanAmPm
                      .children("#click-pm")
              ...
              s('<div id="click-pm">PM</div>')
                .on("click", function () {
                  I.spanAmPm.children("#click-pm").addClass("text-primary"),
                    I.spanAmPm
                      .children("#click-am")
                      .removeClass("text-primary"),
                    (I.amOrPm = "PM");
                ...
                .appendTo(this.spanAmPm))
            : (this.spanAmPm.empty(),
              s('<div id="click-am">AM</div>').appendTo(this.spanAmPm),
              s('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))),
        s(
          '<button type="button" class="bsm-btn-flat picker__clear" tabindex="' +
            (r.twelvehour ? "3" : "1") +
            '">' +
            r.cleartext +
            "</button>"
        )
          .click(s.proxy(this.clear, this))
          .appendTo(this.footer),
        s(
          '<button type="button" class="bsm-btn-flat picker__close" tabindex="' +
            (r.twelvehour ? "3" : "1") +
            '">' +
            r.canceltext +
            "</button>"
        )
          .click(s.proxy(this.hide, this))
          .appendTo(this.footer),
        s(
          '<button type="button" class="bsm-btn-flat picker__close" tabindex="' +
            (r.twelvehour ? "3" : "1") +
          ...
          .click(s.proxy(this.done, this))
          .appendTo(this.footer),
        this.spanHours.click(s.proxy(this.toggleView, this, "hours")),
        this.spanMinutes.click(s.proxy(this.toggleView, this, "minutes")),
        S.on("focus.clockpicker click.clockpicker", s.proxy(this.show, this));
      var O,
        P,
        D,
        N,
        L = s('<div class="clockpicker-tick"></div>');
      if (r.twelvehour)
        for (O = 1; O < 13; O += 1)
          (P = L.clone()),
            (D = (O / 6) * Math.PI),
            (N = y),
            P.css({
              left: v + Math.sin(D) * N - b,
              top: v - Math.cos(D) * N - b,
            }),
            P.html(0 === O ? "00" : O),
            g.append(P),
            P.on(h, l);
      ...
      for (O = 0; O < 60; O += 5)
        (P = L.clone()),
          (D = (O / 30) * Math.PI),
          P.css({
            left: v + Math.sin(D) * y - b,
            top: v - Math.cos(D) * y - b,
          }),
          P.html(e(O)),
          E.append(P),
          P.on(h, l);
      if (
        (d.on(h, function (t) {
          0 === s(t.target).closest(".clockpicker-tick").length && l(t, !0);
        }),
        c)
      ) {
        var M = u.find(".clockpicker-canvas"),
          H = t("svg");
        H.setAttribute("class", "clockpicker-svg"),
          H.setAttribute("width", w),
          H.setAttribute("height", w);
        var j = t("g");
        j.setAttribute("transform", "translate(" + v + "," + v + ")");
        var W = t("circle");
        ...
        var V = t("circle");
        V.setAttribute("class", "clockpicker-canvas-bg"),
          V.setAttribute("r", b),
          j.appendChild(R),
          j.appendChild(V),
          j.appendChild(W),
    ...
    var s = window.jQuery,
      ...
      c =
        ...
        (function () {
          ...
          return (
            (e.innerHTML = "<svg/>"),
            (t = (e.firstChild && e.firstChild.namespaceURI) == l),
            (e.innerHTML = ""),
            t
          );
        })(),
    ...
    (n.DEFAULTS = {
        ...
        if (!this.isShown) {
          o(this.options.beforeShow),
            s(":input").each(function () {
              s(this).attr("tabindex", -1);
            });
          var i = this;
          this.input.blur(),
            this.popover.addClass("picker--opened"),
            this.input.addClass("picker__input picker__input--active"),
            s(document.body).css("overflow", "hidden");
          var n = (
          ...
          (this.hours = +n[0] || 0),
            ...
            a.on(
              ...
              function (t) {
                var e = s(t.target);
                0 === e.closest(i.popover.find(".picker__wrap")).length &&
                  0 === e.closest(i.input).length &&
                  i.hide();
              }
            ),
      ...
      (n.prototype.hide = function () {
        o(this.options.beforeHide),
          ...
          (this.isShown = !1),
          s(":input").each(function (t) {
            s(this).attr("tabindex", t + 1);
          }),
          a.off(
      ...
      (n.prototype.toggleView = function (t, e) {
        var i = !1;
        "minutes" === t &&
          "visible" === s(this.hoursView).css("visibility") &&
          (o(this.options.beforeHourSelect), (i = !0));
        var n = "hours" === t,
      ...
      (n.prototype.setHand = function (t, i, n, o) {
        ...
        if (
          ...
          (this[this.currentView] = r),
          l ? this.spanHours.html(r) : this.spanMinutes.html(e(r)),
          c)
        ) {
          var g = Math.sin(a) * (f - b),
            v = -Math.cos(a) * (f - b),
            w = Math.sin(a) * f,
            C = -Math.cos(a) * f;
      ...
      (n.prototype.done = function () {
        ...
        var t = this.input.prop("value"),
          i = e(this.hours) + ":" + e(this.minutes);
        this.options.twelvehour && (i += this.amOrPm),
  ...
  (function (t) {
    ...
    function o(t, e) {
      ...
      t && i
        ...
        : t || i || (e.removeClass("valid"), e.addClass("invalid"));
    }
    (t.fn.characterCounter = function () {
      return this.each(function () {
        var o = t(this);
        o.parent().find('span[class="character-counter"]').length ||
          (void 0 !== o.attr("data-length") &&
            (o.on("input", e), o.on("focus", e), o.on("blur", n), i(o)));
      });
    }),
      t(document).ready(function () {
    ...
    var e = {
      init: function (e) {
        ...
        return this.each(function (i) {
          ...
          function r(t) {
            return t >= T ? t % T : t < 0 ? r(T + (t % T)) : t;
          }
          function a(i) {
            (I = !0),
              R.hasClass("scrolling") || R.addClass("scrolling"),
              null != j && window.clearTimeout(j),
              (j = window.setTimeout(function () {
                (I = !1), R.removeClass("scrolling");
              }, e.duration));
            var n,
              o,
              s,
              ...
              d = b;
            if (
              ((_ = "number" == typeof i ? i : _),
              (b = Math.floor((_ + C / 2) / C)),
              (s = _ - b * C),
              (a = s < 0 ? 1 : -1),
              (l = (-a * s * 2) / C),
              (o = T >> 1),
              e.fullWidth
                ? (u = "translateX(0)")
                : ((u = "translateX(" + (R[0].clientWidth - g) / 2 + "px) "),
                  (u += "translateY(" + (R[0].clientHeight - v) / 2 + "px)")),
              z)
            ) {
              var h = b % T,
                p = H.find(".bsm-indicator-item.active");
              p.index() !== h &&
                (p.removeClass("active"),
                H.find(".bsm-indicator-item").eq(h).addClass("active"));
            }
            for (
              (!$ || (b >= 0 && b < T)) &&
                ((c = m[r(b)]),
                t(c).hasClass("active") ||
                  (R.find(".bsm-carousel-item").removeClass("active"),
                  t(c).addClass("active")),
                (c.style[O] =
                  u +
                  " translateX(" +
              ...
              e.fullWidth
                ...
                : ((zTranslation = e.dist * (2 * n + l * a)),
                  (tweenedOpacity = 1 - 0.2 * (2 * n + l * a))),
                (!$ || b + n < T) &&
                  (((c = m[r(b + n)]).style[O] =
                    u +
                    " translateX(" +
            ...
            if (
              ((!$ || (b >= 0 && b < T)) &&
                ...
                (c.style.opacity = tweenedOpacity),
                (c.style.display = "block")),
              d !== b && "function" == typeof e.onCycleTo)
            ) {
              var f = R.find(".carousel-item").eq(r(b));
              e.onCycleTo.call(this, f, L);
            }
            "function" == typeof W && (W.call(this, f, L), (W = null));
          }
          function l() {
            var t, e, i;
            (e = (t = Date.now()) - D),
              ...
              (i = _ - P),
              (P = _),
              (A = 0.8 * ((1e3 * i) / (1 + e)) + 0.2 * A);
          }
          function c() {
            var t, i;
            k &&
              ((t = Date.now() - D),
              (i = k * Math.exp(-t / e.duration)) > 2 || i < -2
                ? (a(S - i), requestAnimationFrame(c))
                : a(S));
          }
          function u(i) {
            if (L) return i.preventDefault(), i.stopPropagation(), !1;
            if (!e.fullWidth) {
              var n = t(i.target).closest(".bsm-carousel-item").index();
              0 !== r(b) - n && (i.preventDefault(), i.stopPropagation()), d(n);
            }
          }
          function d(t) {
            var e = (b % T) - t;
            $ ||
              (e < 0
                ? Math.abs(e + T) < Math.abs(e) && (e += T)
                : e > 0 && Math.abs(e - T) < e && (e -= T)),
              e < 0
                ? R.trigger("carouselNext", [Math.abs(e)])
                : e > 0 && R.trigger("carouselPrev", [e]);
          }
          function h(e) {
            "mousedown" === e.type &&
              t(e.target).is("img") &&
          ...
          function f(t) {
            if (w)
              return (
                ...
                clearInterval(N),
                (S = _),
                (A > 10 || A < -10) && (S = _ + (k = 0.9 * A)),
                (S = Math.round(S / C) * C),
                $ && (S >= C * (T - 1) ? (S = C * (T - 1)) : S < 0 && (S = 0)),
                (k = S - _),
                (D = Date.now()),
          ...
          var m,
            ...
            L,
            M,
            H = t('<ul class="bsm-indicators"></ul>'),
            j = null,
            W = null,
            R = t(this),
            V = R.find(".bsm-carousel-item").length > 1,
            z = (R.attr("data-indicators") || e.indicators) && V,
            $ = R.attr("data-no-wrap") || e.noWrap || !V,
            F = R.attr("data-namespace") || n + i;
          R.attr("data-namespace", F);
          var B = function (e) {
            var i = R.find(".bsm-carousel-item.active").length
                ? R.find(".bsm-carousel-item.active").first()
                : R.find(".bsm-carousel-item").first(),
              n = i.find("img").first();
            if (n.length)
              if (n[0].complete)
                if (n.height() > 0) R.css("height", n.height());
                else {
          ...
          if (
            (e.fullWidth &&
              ...
              B(),
              z &&
                R.find(".bsm-carousel-fixed-item").addClass("with-indicators")),
            R.hasClass("initialized"))
          )
            return (
              t(window).trigger("resize"), R.trigger("carouselNext", [1e-6]), !0
            );
          R.addClass("initialized"),
            (w = !1),
            (_ = S = 0),
            (m = []),
            (g = R.find(".bsm-carousel-item").first().innerWidth()),
            (v = R.find(".bsm-carousel-item").first().innerHeight()),
            (C = 2 * g + e.padding),
            R.find(".bsm-carousel-item").each(function (e) {
              if ((m.push(t(this)[0]), z)) {
                var i = t('<li class="bsm-indicator-item"></li>');
            ...
            ["webkit", "Moz", "O", "ms"].every(function (t) {
              var e = t + "Transform";
              return void 0 === document.body.style[e] || ((O = e), !1);
            });
          var q = Bsmkit.throttle(function () {
            if (e.fullWidth) {
              g = R.find(".bsm-carousel-item").first().innerWidth();
              R.find(".bsmcarousel-item.active").height();
              (C = 2 * g + e.padding), (S = _ = 2 * b * g), B(!0);
            } else a();
          }, 200);
          t(window)
            .off("resize.bsm-carousel-" + F)
            .on("resize.bsm-carousel-" + F, q),
            void 0 !== window.ontouchstart &&
              (R.on("touchstart.carousel", h),
              R.on("touchmove.carousel", p),
              R.on("touchend.carousel", f)),
            R.on("mousedown.carousel", h),
            R.on("mousemove.carousel", p),
            R.on("mouseup.carousel", f),
            R.on("mouseleave.carousel", f),
            R.on("click.carousel", u),
            a(_),
            t(this).on("carouselNext", function (t, e, i) {
              void 0 === e && (e = 1),
                "function" == typeof i && (W = i),
                (S = C * Math.round(_ / C) + C * e),
                _ !== S &&
                  ((k = S - _), (D = Date.now()), requestAnimationFrame(c));
            }),
            ...
            t(this).on("carouselSet", function (t, e, i) {
              void 0 === e && (e = 0), "function" == typeof i && (W = i), d(e);
            });
        });
      },
      next: function (e, i) {
      ...
      destroy: function () {
        ...
        t(this).removeAttr("data-namespace"),
          ...
          void 0 !== window.ontouchstart &&
            t(this).off(
              "touchstart.bsm-carousel touchmove.bsm-carousel touchend.bsm-carousel"
            ),
          t(this).off(
            "mousedown.bsm-carousel mousemove.bsm-carousel mouseup.bsm-carousel mouseleave.bsm-carousel click.carousel"
          );
      },
    };
      ...
      init: function (e) {
        return this.each(function () {
          var i = t("#" + t(this).attr("data-activates")),
            n = (t("body"), t(this)),
            o = n.parent(".bsm-tap-target-wrapper"),
            s = o.find(".bsm-tap-target-wave"),
            r = o.find(".bsm-tap-target-origin"),
            a = n.find(".bsm-tap-target-content");
          o.length ||
            (o = n
              .wrap(t('<div class="bsm-tap-target-wrapper"></div>'))
              .parent()),
            a.length ||
              ((a = t('<div class="bsm-tap-target-content"></div>')),
              n.append(a)),
            s.length ||
              ((s = t('<div class="bsm-tap-target-wave"></div>')),
              r.length ||
                ((r = i.clone(!0, !0)).addClass("bsm-tap-target-origin"),
                r.removeAttr("id"),
                r.removeAttr("style"),
                s.append(r)),
              o.append(s));
          var l = function () {
              o.is(".open") &&
                (o.removeClass("open"),
                r.off("click.bsmTapTarget"),
                t(document).off("click.bsmTapTarget"),
                t(window).off("resize.bsmTapTarget"));
            },
            c = function () {
              ...
              if (!e)
                for (
                  var r = i.parents(), l = 0;
                  l < r.length && !(e = "fixed" == t(r[l]).css("position"));
                  l++
                );
              var c = i.outerWidth(),
                u = i.outerHeight(),
              ...
              (j.top = _ ? E : ""),
                ...
                s.css({ top: M, left: H, width: N, height: L });
            };
          "open" == e &&
            (c(),
            o.is(".open") ||
              ...
              setTimeout(function () {
                r
                  .off("click.bsmTapTarget")
                  .on("click.bsmTapTarget", function (t) {
                    l(), r.off("click.bsmTapTarget");
                  }),
                  t(document)
                    .off("click.bsmTapTarget")
                    .on("click.bsmTapTarget", function (e) {
                      l(), t(document).off("click.bsmTapTarget");
                    });
                var e = Bsmkit.throttle(function () {
                  c();
                }, 200);
                t(window)
                  .off("resize.bsmTapTarget")
                  .on("resize.bsmTapTarget", e);
              }, 0))),
            "close" == e && l();
        });
      },
  ...
  (function (t) {
    ...
    (a.prototype = {
      ...
      updateItemHTML: function () {
        ...
        var n = i.type;
        if (
          (h("BeforeChange", [e.currItem ? e.currItem.type : "", n]),
          (e.currItem = i),
          !e.currTemplate[n])
        ) {
          var s = !!e.st[n] && e.st[n].markup;
          h("FirstMarkupParse", s), (e.currTemplate[n] = !s || t(s));
        }
          ...
          if ((_(), i.src)) {
            ...
            if (s.length) {
              ...
              r &&
                ...
                (y = s.after(v).detach().removeClass(g))),
    ...
    t.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, n) {
          ...
          return (
            e._parseMarkup(n, { title: E(i), img_replaceWith: i.img }, i),
            e.resizeImage(),
            i.hasSize
              ? (T && clearInterval(T),
                i.loadError
        ...
        initGallery: function () {
          ...
          (s += " mfp-gallery"),
            ...
            u("MarkupParse" + o, function (t, n, o, s) {
              ...
              o.counter = r > 1 ? I(i.tCounter, s.index, r) : "";
            }),
